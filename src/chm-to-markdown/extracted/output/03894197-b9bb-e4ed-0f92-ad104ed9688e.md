...
---  
RebarContainer Members  
[RebarContainer Class](61979a57-facc-d97a-7a35-ee04eed59156.md "RebarContainer Class") Methods Properties See Also  
---  
The [RebarContainer](61979a57-facc-d97a-7a35-ee04eed59156.md "RebarContainer Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AppendItemFromCurves](5e226c33-9073-1211-2ddb-8bd061b6ebf1.md "AppendItemFromCurves Method") | Appends an Item to the RebarContainer. Fills its data on base of the Rebar. |
| [AppendItemFromCurvesAndShape](4f027562-d8b9-17b7-74db-3ffde449be5f.md "AppendItemFromCurvesAndShape Method") | Appends an Item to the RebarContainer. Fills its data on base of the Rebar. |
| [AppendItemFromRebar](b7e0adc7-0f2e-af1e-9224-3f1ae4067e3c.md "AppendItemFromRebar Method") | Appends an Item to the RebarContainer. Fills its data on base of the Rebar. Will throw exception if given rebar is not shape driven. Will throw exception if given rebar has moved bars in set. |
| [AppendItemFromRebarShape](292aade1-0459-1a6a-9bd3-715e8bb634df.md "AppendItemFromRebarShape Method") | Appends an Item to the RebarContainer. Fills its data on base of the Rebar. |
...
| [CanApplyPresentationMode](4320a85e-3b48-719a-ec2e-ee74991c2dc2.md "CanApplyPresentationMode Method") | Checks if a presentation mode can be applied for this RebarContainer in the given view. |
...
| [ClearItems](4ba16a7e-eaaf-510b-2527-ce32948972bc.md "ClearItems Method") | Clears all the Items stored in this Rebar Container element. |
| [Contains](ed75fef3-8c01-c440-a1ca-db20914712fa.md "Contains Method") | Checks if the RebarContainer has this item as one of its members. |
| [Create](48da4e91-7ce6-5636-458f-bc7287ad98b0.md "Create Method") | Creates a new instance of a Rebar Container element within the project. |
...
| [GetBasicIEnumerator](53f23133-175e-f3ce-f58d-a77358ca5129.md "GetBasicIEnumerator Method") | Returns an enumerator that iterates through a collection. |
...
| [GetEnumerator](f4f0511f-3ff8-d69f-a457-af5be5b91679.md "GetEnumerator Method") | Returns an enumerator that iterates through a collection. |
...
| [GetHostId](da5694c7-b1bb-6155-47f9-93b0b61776ea.md "GetHostId Method") | The element that contains the rebar. |
| [GetItem](d591f494-7c8c-a8ef-1a6a-31dc8dbc2ee4.md "GetItem Method") | Gets the item stored in the RebarContainer at the associated index. |
...
| [GetParametersManager](276727c8-b3fc-d31c-a7f9-bac1871a20b1.md "GetParametersManager Method") | Returns an object used to manage parameters of the Rebar Container. |
...
| [GetRebarContainerIterator](e3368385-4e90-a01e-9335-18d0bdc75790.md "GetRebarContainerIterator Method") | Returns a Rebar Container Iterator that iterates through the Rebar Container Items. |
| [GetReinforcementRoundingManager](5149cdb5-f393-6b9e-e101-0fc3384d1236.md "GetReinforcementRoundingManager Method") | Returns an object for managing reinforcement rounding override settings. |
...
| [HasPresentationOverrides](cc0e04ac-56a9-f1a5-cae8-9962b0aa60a4.md "HasPresentationOverrides Method") | Identifies if any RebarContainerItem of this RebarContainer has overridden default presentation settings for the given view. |
...
| [IsItemHidden](0c86e348-7204-5953-4398-e6ee29bc79c1.md "IsItemHidden Method") | Identifies if a given RebarContainerItem is hidden in this view. |
...
| [IsUnobscuredInView](1a9453cc-db8c-bbcf-dd6c-5380b809df09.md "IsUnobscuredInView Method") | Checks if this rebar container element is shown unobscured in a view. |
...
| [RemoveItem](a72cdb40-2bb0-47c2-d0da-acca1289099e.md "RemoveItem Method") | Removes Item from the Rebar Container. |
...
| [SetHostId](affeac8e-7d19-ee94-4a29-3011ab93e8a0.md "SetHostId Method") | The element that contains the rebar. |
| [SetItemHiddenStatus](c2eccd30-4ff7-7d9c-7858-548fc7269505.md "SetItemHiddenStatus Method") | Sets the RebarContainerItem to be hidden or unhidden in the given view. |
| [SetUnobscuredInView](484d706c-e0df-473f-5427-f3eeac17eedc.md "SetUnobscuredInView Method") | Sets this rebar container element to be shown unobscured in a view. |
...
| [ItemsCount](1ef0af6d-ca4a-9a2e-8095-f86d20286c59.md "ItemsCount Property") | The count of Items in this Rebar Container. |
...
| [PresentItemsAsSubelements](a949781c-f4be-54bf-6f74-52dff40b28f7.md "PresentItemsAsSubelements Property") | Identifies if Items should be presented in schedules and tags as separate subelements. |
| [ScheduleMark](45faac1a-a8ec-2df3-4cfd-8d49b98ee92b.md "ScheduleMark Property") | The Schedule Mark parameter. On creation, the Schedule Mark is set to a value that is unique to the host, but it can be set to any value. |
