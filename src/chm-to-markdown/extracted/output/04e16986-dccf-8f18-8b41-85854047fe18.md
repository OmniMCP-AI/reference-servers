...
---  
Wire Members  
[Wire Class](c2acf13b-0d8b-8415-9682-ae64eb5e5895.md "Wire Class") Methods Properties See Also  
---  
The [Wire](c2acf13b-0d8b-8415-9682-ae64eb5e5895.md "Wire Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AppendVertex](fd3b4f99-3178-a3f9-c88d-2fd1a0a34fc5.md "AppendVertex Method") | Appends one vertex to the end of the wire. |
...
| [AreVertexPointsValid](fd5fb218-eecf-c670-2907-59f5446a866c.md "AreVertexPointsValid Method") | Checks if the given vertex points are valid for the wire. |
...
| [ConnectTo](a008dc1e-81a9-8e1c-cc9e-c014a68c2bd9.md "ConnectTo Method") | Connects the wire to other elements. |
| [Create](748caa8a-5792-91bf-dd3c-b62beba5efd3.md "Create Method") | Creates a new wire. |
...
| [GetMEPSystems](8c5df7ee-4ee6-50d5-ca5a-70dcd6f6961f.md "GetMEPSystems Method") | Gets the systems to which the wire belongs. |
...
| [GetVertex](e9fbd76e-e1b8-4d11-2368-27998769bc19.md "GetVertex Method") | Gets the position of an existing vertex. |
...
| [InsertVertex](998dbada-2ac1-72e7-c7b7-603492e83642.md "InsertVertex Method") | Inserts a new vertex before the specified index. |
...
| [IsVertexPointValid](fbb3ef78-b28c-9637-b995-b03e461bc9a4.md "IsVertexPointValid Method") | Checks if the given vertex point can be added to this wire. |
...
| [RemoveVertex](0d16213b-1098-6ca9-1e2b-70068f619ae8.md "RemoveVertex Method") | Removes the vertex corresponding to the specified index. Can not remove the start or end vertex if it already connects to other element. |
...
| [GroundConductorNum](77c42cca-7a15-32a2-3a4e-172cb533a022.md "GroundConductorNum Property") | The ground conductor number. Its default value is zero after created. |
...
| [HotConductorNum](8aee795d-931b-c13a-e4d5-bca5b01b724b.md "HotConductorNum Property") | The hot conductor number. Its default value is zero after created. |
...
| [NeutralConductorNum](e1410036-e4b6-2677-b354-2d860cba3c31.md "NeutralConductorNum Property") | The neutral conductor number. Its default value is zero after created. |
| [NumberOfVertices](a3396437-4d65-df7f-9400-97e5f69c0d0a.md "NumberOfVertices Property") | The number of vertices of the wire, including the start and end point. |
...
| [WiringType](7a670559-0af9-8ed0-eee7-4afdff667b15.md "WiringType Property") | The wiring type(arc or chamfer) for the wire. |
