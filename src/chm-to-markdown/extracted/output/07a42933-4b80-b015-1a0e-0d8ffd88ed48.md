...
---  
The [ViewSystemsAnalysisReport](a7b5b7de-dfdb-e57f-7fac-1ff1dbf35e4d.md "ViewSystemsAnalysisReport Class") type exposes the following members.
# Properties
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AnalysisDateAndTime](d16ea8b2-d425-f8ef-7c0b-d1023fe9c81d.md "AnalysisDateAndTime Property") | Identifies the analysis date and time when it was requested. |
...
| [ReportStyle](93f766a8-2575-fdf4-6f05-278c4cf921a6.md "ReportStyle Property") | The report style that specifies the display content. |
...
| [SystemsAnalysisOutputFolder](f7814f7b-fdd7-79cc-bda3-7b6bd4906ed1.md "SystemsAnalysisOutputFolder Property") | The full path of the output folder for systems analysis |
| [SystemsAnalysisWorkflowFile](afa99f32-2a4f-94bc-d06a-164df200e060.md "SystemsAnalysisWorkflowFile Property") | The full path name of the original system analysis workflow file. |
...
| [WeatherFile](e1ae6850-4df0-d36d-3dfc-7f40acd06706.md "WeatherFile Property") | The full path name of the weather file used for the systems analysis. |
