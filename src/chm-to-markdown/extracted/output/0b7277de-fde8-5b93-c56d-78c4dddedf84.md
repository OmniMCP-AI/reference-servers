# SetSurfaceBackgroundPatternColor Method
...
---  
```text
Public Function SetSurfaceBackgroundPatternColor ( _
	color As Color _
...
# ### Parameters
color
    Type: [Autodesk.Revit.DB..::..Color](3735f9b9-d477-09ea-25bd-67f34134595f.md "Color Class") Value of the surface background color for the override. InvalidColorValue means no override is set. 
# ### Return Value
