# SetCutBackgroundPatternColor Method
...
---  
```text
Public Function SetCutBackgroundPatternColor ( _
	color As Color _
...
# ### Parameters
color
    Type: [Autodesk.Revit.DB..::..Color](3735f9b9-d477-09ea-25bd-67f34134595f.md "Color Class") Value of the cut face background color for the override. InvalidColorValue means no override is set. 
# ### Return Value
