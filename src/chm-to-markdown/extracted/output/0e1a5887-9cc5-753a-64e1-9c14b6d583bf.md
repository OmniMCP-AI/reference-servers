...
---  
StairsRun Members  
[StairsRun Class](ea0e49a0-a007-79d0-c902-a24b1359ae28.md "StairsRun Class") Methods Properties See Also  
---  
...
| [CreateSketchedRun](bb782d95-4792-8335-401c-97170542b96b.md "CreateSketchedRun Method") | Creates a sketched run in the project document by providing a group of boundary curves and riser curves. |
| [CreateSketchedRunWithSlopeData](617ef98f-bb7b-c4ec-0342-bf2b4d743ff8.md "CreateSketchedRunWithSlopeData Method") | Creates a sketched run in the project document by providing a group of boundary curves and riser curves, specifying slope type and height for boundary curves. |
| [CreateSpiralRun](2f31d042-a202-a1a4-42fe-998b02e26a4d.md "CreateSpiralRun Method") | Creates a spiral run in the project document by providing the center, start angle and included angle. |
| [CreateStraightRun](54fd7462-c16c-41bf-705f-ede3af0bc572.md "CreateStraightRun Method") | Creates a straight run in the project document. |
...
| [GetAllSupports](a860f418-9de2-3600-5105-a48be8544a41.md "GetAllSupports Method") | Retrieves all supports hosted by the stair's run. |
| [GetConnections](db619f61-5444-37f9-1057-97d35caf5eed.md "GetConnections Method") | Returns information about the connections in which the stairs run participates. The stairs run may have no connection, or have at maximum two connections at the lower and upper ends. |
...
| [GetFootprintBoundary](98862b51-f40e-d085-d574-2e6896afdb32.md "GetFootprintBoundary Method") | Returns the run's boundary curves which are projected on the stairs base level. |
...
| [GetLeftSupports](030d4d7a-26c7-c8ec-a924-d15fa74938d3.md "GetLeftSupports Method") | Retrieves all supports on the left side of run boundaries. |
...
| [GetNumberSystemReference](37d8b848-520b-47d1-5cad-f5c4e41c5979.md "GetNumberSystemReference Method") | Gets the number system reference corresponding to the given reference options. |
...
| [GetRightSupports](d28ad844-a878-5953-df59-5f7f092207ea.md "GetRightSupports Method") | Retrieves all supports on the right side of run boundaries. |
| [GetStairs](70bc6ef7-27a5-b1a6-aada-7ffedfbf0260.md "GetStairs Method") | Returns the stairs to which the stairs run belongs. |
| [GetStairsPath](cb460743-dc63-545e-8d88-45061f2d2abd.md "GetStairsPath Method") | Returns the stairs path curves on the run. The curves are projected on base level of the stairs. |
...
| [SetLocationPathForSpiralRun](f8304e58-c7a3-410c-8369-8cd313043a16.md "SetLocationPathForSpiralRun Method") | Set Location path for a spiral run. |
| [SetLocationPathForStraightRun](6ff2ff5e-36ad-eb4c-2aef-4f0b5208177d.md "SetLocationPathForStraightRun Method") | Set location path for a straight run by giving a line. |
