...
---  
ExportPDFSettings Members  
[ExportPDFSettings Class](66156539-3f22-d986-ea46-49e772d1c451.md "ExportPDFSettings Class") Methods Properties See Also  
---  
The [ExportPDFSettings](66156539-3f22-d986-ea46-49e772d1c451.md "ExportPDFSettings Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](089c5517-8e5d-7c74-b53b-d59dacb06c5d.md "Create Method") | Returns an new created ExportPDFSettings element in the document with specified settings. |
...
| [FindByName](c7b081d1-a996-7a34-2486-a80af67977ba.md "FindByName Method") | Returns settings element by name. |
| [GetActivePredefinedSettings](2ccf1b3b-786a-4cb4-c9e9-962c42a05d92.md "GetActivePredefinedSettings Method") | Gets the active settings element in the document. |
...
| [GetOptions](f5d51aa8-71ae-0526-1668-e0d97eb8315e.md "GetOptions Method") | Gets a copy of options from settings for exporting. Modification on this options would not change the element. |
...
| [IsValidName](854b7152-17e2-8bc4-2fb4-2fd2f571812e.md "IsValidName Method") | Returns result that the proposed name is valid and not exist in the specified document. |
...
| [ListNames](7ad9e021-bd2f-5b85-2138-b7698e41b71a.md "ListNames Method") | Returns all the names of the settings instances in the document. |
...
| [SetOptions](146cd6a1-7f80-a2dc-b1f3-525900536b9f.md "SetOptions Method") | Sets options for exporting. |
