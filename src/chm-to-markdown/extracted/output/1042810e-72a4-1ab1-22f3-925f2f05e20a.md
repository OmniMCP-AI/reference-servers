...
---  
NumberingSchema Members  
[NumberingSchema Class](8f2b22da-5963-301f-44d8-10c68828c436.md "NumberingSchema Class") Methods Properties See Also  
---  
The [NumberingSchema](8f2b22da-5963-301f-44d8-10c68828c436.md "NumberingSchema Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AppendSequence](0a89ca78-ca34-93fa-4fa7-71883a535497.md "AppendSequence Method") | Appends all elements of one numbering sequence to the end of another sequence. |
...
| [AssignElementsToSequence](fd765b3c-368b-cf14-6bb0-b772f503370f.md "AssignElementsToSequence Method") | Assigns the input elements to a sequence identified by the given partition name. |
...
| [ChangeNumber](dc93cd7f-dc11-45da-3ed6-c459d1c55c97.md "ChangeNumber Method") | Replaces an existing number with a new one (that does not exist yet). |
...
| [GetMinimumNumberOfDigits](80ac3f63-6383-ba62-380f-0e61b98e8dd7.md "GetMinimumNumberOfDigits Method") | Returns the minimum number of digits to be used for formating the Number parameter of all enumerable elements of the given document. |
...
| [GetNumberingSchema](fb3e529c-bccd-40fb-c24d-c5de5296edea.md "GetNumberingSchema Method") | Returns an instance of the specified Numbering Schema in the given document. |
| [GetNumberingSequences](0eea26e0-24c0-154b-b7ac-c24b47eafa96.md "GetNumberingSequences Method") | Returns all numbering sequences within this numbering schema. |
| [GetNumbers](3153106d-9f77-eb5d-20af-cd651e91b640.md "GetNumbers Method") | Returns all numbers currently used in the given numbering sequence |
...
| [GetSchemasInDocument](9bd7a9f5-49af-1d41-9f55-932723b7023e.md "GetSchemasInDocument Method") | Returns a set of Ids of all Numbering Schema elements for a given document. |
...
| [IsValidPartitionName](a250660a-5dcb-47a6-1960-e3750fd4df8a.md "IsValidPartitionName Method") | Tests if the given string can be used as a name for a numbering partition. |
...
| [MergeSequences](45697dc7-68b2-4fa8-1bea-8f65983f23a0.md "MergeSequences Method") | Merges all elements from given numbering sequences to a new sequence. |
| [MoveSequence](9ae38f60-e76f-5bd7-1d71-bd57cf06f641.md "MoveSequence Method") | Moves all elements of a numbering sequence from one partition to another. |
...
| [RemoveGaps](a97a1aff-4afe-7aa7-098a-f71229efdccd.md "RemoveGaps Method") | Removes gaps, if any, in a numbering sequence |
...
| [SetMinimumNumberOfDigits](5b78eda1-9ad6-9c9d-bfe4-bdb6752c262f.md "SetMinimumNumberOfDigits Method") | Sets a new value for the minimum number of digits to be used for formating the Number parameter of all numbered elements of the given document. |
| [ShiftNumbers](8962e7e3-0860-acd5-c488-d8f93867b1c1.md "ShiftNumbers Method") | Shifts all numbers in the sequence so the starting number has the given value. |
...
| [MaximumStartingNumber](f7a8b906-ee60-2a71-bc1a-30fa81b4f299.md "MaximumStartingNumber Property") | A static property defining the maximum number a numbering sequence can use as its starting number (the lowest number in the sequence). |
...
| [NumberingParameterId](94659f29-c7f2-9643-f443-9451a3177cc2.md "NumberingParameterId Property") | Id of the parameter that stores values of the numbers on enumerated elements. |
...
| [SchemaType](6c9d8ec5-3622-95ca-e3dc-c663f0a3b155.md "SchemaType Property") | Identifies the kind of elements/objects this numbering schema is used for. |
