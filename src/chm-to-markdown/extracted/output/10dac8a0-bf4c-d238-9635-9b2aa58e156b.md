# Link Method (String, ImportOptions3DM, View)
...
Revit 2024 API  
---  
Document..::..Link Method (String, ImportOptions3DM, View)  
...
# ### Parameters
file
    Type: System..::..String Full path of the file to link. File must exist and must be a valid 3DM file. 
options
