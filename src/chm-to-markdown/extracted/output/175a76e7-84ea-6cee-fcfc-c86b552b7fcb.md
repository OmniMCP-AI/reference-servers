...
---  
DuctSettings Members  
[DuctSettings Class](cd632c8e-a520-2efb-a417-9dfa5677d134.md "DuctSettings Class") Methods Properties See Also  
---  
The [DuctSettings](cd632c8e-a520-2efb-a417-9dfa5677d134.md "DuctSettings Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetDuctSettings](80923557-908d-ce4b-b711-9134e567a658.md "GetDuctSettings Method") | Get the duct settings of the project. |
...
| [GetPressLossCalculationServerInfo](301d0233-9033-7ed8-9a66-aaa55c63ddfd.md "GetPressLossCalculationServerInfo Method") | Get the MEPServerInfo of the current pipe pressure loss calculation server. |
| [GetSpecificFittingAngles](0f140871-90cc-03cb-81f7-0cc33a1b24bc.md "GetSpecificFittingAngles Method") | Gets the list of specific fitting angles. |
| [GetSpecificFittingAngleStatus](3d357c63-7ac9-01d1-7468-ebd4a3bf998a.md "GetSpecificFittingAngleStatus Method") | Gets the status of given specific angle. |
...
| [IsNetworkBasedCalculationsEnabled](ec71c154-e6cc-496f-3e73-c51735b4a2bc.md "IsNetworkBasedCalculationsEnabled Method") | Indicates whether network based calculations for duct networks is enabled in the specified document. |
...
| [IsValidSpecificFittingAngle](4bfcf63d-bb63-a480-0487-a1d75f1308f7.md "IsValidSpecificFittingAngle Method") | Checks that the given value is a valid specific fitting angle. The specific fitting angles are angles of 90, 60, 45, 30, 22.5 or 11.25 degrees. |
...
| [SetPressLossCalculationServerInfo](8632a1d8-5126-ead1-985e-ade923e55461.md "SetPressLossCalculationServerInfo Method") | Set the MEPServerInfo of the current pipe pressure loss calculation server. |
| [SetSpecificFittingAngleStatus](9461503b-101d-ff04-6ad4-805578deb5f8.md "SetSpecificFittingAngleStatus Method") | Sets the status of given specific angle. |
...
| --- | --- |
| --- | --- | --- |
| [AirDensity](fffd52f7-044c-1a46-6943-ff877dec3279.md "AirDensity Property") | The air density in kg/ft^3. |
| [AirViscosity](6c77b0f7-1565-e199-eef0-ffadc4714b25.md "AirViscosity Property") | The kinematic viscosity of air in ft^2/s. |
...
| [Centerline](9a7b2e55-5810-62ea-76a4-5db9b5f2e5ab.md "Centerline Property") | The abbreviation of the Centerline (=) string. |
| [ConnectorSeparator](ca95fd1d-8c62-437a-f0be-feefe37ec20f.md "ConnectorSeparator Property") | The duct connector separator string. |
...
| [FittingAngleUsage](8112e243-c20e-35e6-02aa-f0e061538cd0.md "FittingAngleUsage Property") | Determine how to use fitting angle during duct layout or modifying layout. |
| [FittingAnnotationSize](ad1cbd39-b54e-6532-3db4-4621d0158663.md "FittingAnnotationSize Property") | The value of fitting annotation size. |
| [FlatOnBottom](6d4acd42-372e-9ed4-bad2-dc019b99239f.md "FlatOnBottom Property") | The abbreviation of the Flat On Bottom (FOB) string. |
| [FlatOnTop](717ef71c-64bf-953a-adad-213004aaf6ca.md "FlatOnTop Property") | The abbreviation of the Flat On Top (FOT) string. |
...
| [NetworkBasedCalculations](b888c721-828c-a71e-32bb-5545f8e07103.md "NetworkBasedCalculations Property") | Indicates whether to enable network based calculations for duct networks. |
| [OvalDuctSizeSeparator](fcde64b8-e345-25cd-29ad-0164438b16ef.md "OvalDuctSizeSeparator Property") | The oval duct size separator string. |
| [OvalDuctSizeSuffix](01a4fd90-4660-a555-b3d4-4388b3e9b4c3.md "OvalDuctSizeSuffix Property") | The oval duct size suffix string. |
...
| [RectangularDuctSizeSeparator](5bbed76e-f811-b98b-288a-6f74aa2b0f2c.md "RectangularDuctSizeSeparator Property") | The rectangular duct size separator string. |
| [RectangularDuctSizeSuffix](6f59f18c-7a72-2819-3670-19f80aede525.md "RectangularDuctSizeSuffix Property") | The rectangular duct size suffix string. |
| [RiseDropAnnotationSize](37074af6-8bb9-b562-2521-a0370382eed8.md "RiseDropAnnotationSize Property") | The rise drop annotation size. |
| [RoundDuctSizePrefix](d1f1f1df-ff92-8640-4aa1-72dd2ef1114c.md "RoundDuctSizePrefix Property") | The round duct size prefix string. |
| [RoundDuctSizeSuffix](abf0c448-17e8-dd63-bc37-8e695d268b75.md "RoundDuctSizeSuffix Property") | The round duct size suffix string. |
| [SetDown](a6b3a1bd-acd6-6ed0-ff42-00cf4ef48d18.md "SetDown Property") | The abbreviation of the Set Down from top (TD) of fitting string. |
| [SetDownFromBottom](a58f3175-0d33-e7ae-fe40-e332b19ea490.md "SetDownFromBottom Property") | The abbreviation of the Set Down from bottom (BD) of fitting string. |
| [SetUp](158723ab-631f-05b6-48d2-75cd9aa0edf0.md "SetUp Property") | The abbreviation of the Set Up from top (TU) of fitting string. |
| [SetUpFromBottom](45e7e748-e45b-1d98-04db-ea9a48314163.md "SetUpFromBottom Property") | The abbreviation of the Set Up from bottom (BU) of fitting string. |
...
| [UseAnnotationScaleForSingleLineFittings](ca019bfb-0ff9-8e14-9848-797bd3fcdd9a.md "UseAnnotationScaleForSingleLineFittings Property") | Indicates whether use annotation scale for single line fittings or not. |
