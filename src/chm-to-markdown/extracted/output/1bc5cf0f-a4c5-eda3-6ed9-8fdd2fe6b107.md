...
---  
```text
public static FailureDefinitionId LockedDeleted { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property LockedDeleted As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ LockedDeleted {
