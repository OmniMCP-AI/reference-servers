...
---  
The [Level](577e5d4e-a558-118c-9dea-3b810b061775.md "Level Class") type exposes the following members.
# Properties
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Elevation](b5d48a18-4aa9-7457-7a6a-6d4966eaf77f.md "Elevation Property") | Retrieves or changes the elevation above or below the ground level. |
...
| [ProjectElevation](895ef506-bfea-cc4e-31f8-aad2af6672e4.md "ProjectElevation Property") | Retrieves the elevation relative to project origin, no matter what values of the Elevation Base parameter is set. |
