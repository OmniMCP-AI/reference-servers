...
---  
RebarCoupler Members  
[RebarCoupler Class](af258367-f0c5-e4d3-f863-1733d7bf6b30.md "RebarCoupler Class") Methods Properties See Also  
---  
The [RebarCoupler](af258367-f0c5-e4d3-f863-1733d7bf6b30.md "RebarCoupler Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CouplerLinkTwoBars](f9b71707-f877-c2a2-1297-a132766e0c53.md "CouplerLinkTwoBars Method") | returns true if the coupler sits on two rebar and false otherwise |
| [Create](52fc10f6-e5b0-0f47-20fa-90be57b48004.md "Create Method") | Creates a new instance of a Rebar Coupler element within the project. |
...
| [GetCoupledReinforcementData](f6b701e8-73e3-3ca1-bb8b-c9bbea755be1.md "GetCoupledReinforcementData Method") | gets the reinforcement data. The returned list will have size = 2. If coupler stays on only one bar one element in this list will be null. |
| [GetCouplerPositionTransform](78db7785-7069-4511-747e-ea0de2702e8d.md "GetCouplerPositionTransform Method") | Return a transform representing the relative position of the coupler at index couplerPositionIndex in the set. |
| [GetCouplerQuantity](d9910074-138f-1d7a-3101-ed6a2ad3fc5b.md "GetCouplerQuantity Method") | Identifies the number of couplers in a set. |
...
| [GetPointsForPlacement](c270a509-8e1d-8e13-2176-d3680045dbe4.md "GetPointsForPlacement Method") | gets the point (or points in case of rebar set) where the coupler is placed |
...
| [IsUnobscuredInView](55abcef4-e64e-4582-2ca3-d10b27102477.md "IsUnobscuredInView Method") | Checks if this rebar coupler element is shown unobscured in a view. |
...
| [SetUnobscuredInView](1e883463-46aa-feb3-1660-dc757dc722d3.md "SetUnobscuredInView Method") | Sets this rebar coupler element to be shown unobscured in a view. |
...
| [CouplerMark](8381cc59-9dff-664c-682b-84d0086f93c1.md "CouplerMark Property") | gets and sets the coupler mark |
...
| [RotationAngle](8594c93b-b0a0-ef01-22b8-1574aa3a6634.md "RotationAngle Property") | Indetifies the rotation angle of the coupler around its axis. |
