...
# ### Parameters
other
    Type: [Autodesk.Revit.DB.DirectContext3D..::..DirectContext3DHandleSettings](cc9d7b07-a4d9-8570-9ed8-c953e241c0d6.md "DirectContext3DHandleSettings Class") The source settings. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
