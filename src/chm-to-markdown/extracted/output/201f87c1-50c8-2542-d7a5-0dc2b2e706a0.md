# Link Method (String, OBJImportOptions, View)
...
Revit 2024 API  
---  
Document..::..Link Method (String, OBJImportOptions, View)  
...
# ### Parameters
file
    Type: System..::..String Full path of the file to link. File must exist and must be a valid OBJ file. 
options
