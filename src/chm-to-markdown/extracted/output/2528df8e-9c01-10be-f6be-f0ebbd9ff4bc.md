...
---  
Material Members  
[Material Class](2ec33007-7a2a-f86a-009b-d4c5d235a307.md "Material Class") Methods Properties See Also  
---  
The [Material](2ec33007-7a2a-f86a-009b-d4c5d235a307.md "Material Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [ClearMaterialAspect](f5ff587a-d617-28e1-c277-1f73ccbe7e3a.md "ClearMaterialAspect Method") | Removes an aspect from the material. |
| [Create](5d8f8735-b814-5ac0-e8c5-114da8caa7bc.md "Create Method") | Creates a new material. |
...
| [Duplicate](683b9b3b-fcd7-299d-e42f-712ac1550f17.md "Duplicate Method") | Duplicates the material |
...
| [IsMaterialOrValidDefault](5337f779-e4d7-4f61-0ed5-df974b111543.md "IsMaterialOrValidDefault Method") | Validates whether the specified element id is a material element. |
...
| [IsNameUnique](7c36f870-2492-fa94-0720-0875df529c42.md "IsNameUnique Method") | Validates whether the material name is unique in document. |
...
| [SetMaterialAspectByPropertySet](73438593-0643-93d6-5c58-1fb39e2efd47.md "SetMaterialAspectByPropertySet Method") | Sets an aspect of the material to a shared property set. |
...
| --- | --- |
| --- | --- | --- |
| [AppearanceAssetId](d02d0677-341a-8d1a-d3eb-35ff82f01695.md "AppearanceAssetId Property") | The ElementId of the AppearanceAssetElement. |
...
| [Color](0c6c0bd9-15db-d839-786d-b33d18311017.md "Color Property") | The color of the material. |
...
| [CutBackgroundPatternColor](d3768cd0-a588-f5d7-62a5-53b91e9c08a1.md "CutBackgroundPatternColor Property") | The color of the material cut background pattern. |
| [CutBackgroundPatternId](290d0d15-afd4-b333-ff39-8d46481b1b06.md "CutBackgroundPatternId Property") | The id of the FillPatternElement used as the background pattern of faces with this material in cut views. |
| [CutForegroundPatternColor](3cad9a34-eb3e-0889-4288-28c5cf2662d8.md "CutForegroundPatternColor Property") | The color of the material cut foreground pattern. |
| [CutForegroundPatternId](9f03bba4-bdb1-5a2e-065e-c1d6ac04bb95.md "CutForegroundPatternId Property") | The id of the FillPatternElement used as the foreground pattern of faces with this material in cut views. |
...
| [MaterialCategory](75828584-b04c-7f5e-3eb1-353bca44cdec.md "MaterialCategory Property") | The name of the material category, e.g. 'Wood' |
| [MaterialClass](ad8d658d-736a-f89c-981a-555f0d69c2e5.md "MaterialClass Property") | The name of the general material type, e.g. 'Wood.' |
...
| [Shininess](fd68b125-5b55-4abc-79e2-55691d45a7ad.md "Shininess Property") | The shininess of the material. |
| [Smoothness](6486d2bb-727e-d62c-b278-4c5ece4d5e7d.md "Smoothness Property") | The smoothness of the material. |
| [StructuralAssetId](9b6f4d74-4c3b-06cc-874c-176758d305db.md "StructuralAssetId Property") | The ElementId of the structural PropertySetElement. |
| [SurfaceBackgroundPatternColor](e06ad303-e935-e851-207e-08748ba58d1b.md "SurfaceBackgroundPatternColor Property") | The color of the material surface background pattern. |
| [SurfaceBackgroundPatternId](6b7f71e4-7d89-ab30-3eda-65ca8bc038e2.md "SurfaceBackgroundPatternId Property") | The id of the FillPatternElement used as the background pattern of faces with this material in normal views. |
| [SurfaceForegroundPatternColor](d9019c51-64ee-caab-aa04-51b594074ec1.md "SurfaceForegroundPatternColor Property") | The color of the material surface foreground pattern. |
| [SurfaceForegroundPatternId](dc5602cc-54d3-2be0-bd3c-4dd9efc14010.md "SurfaceForegroundPatternId Property") | The id of the FillPatternElement used as the foreground pattern of faces with this material in normal views. |
| [ThermalAssetId](76db3e11-fdaa-14f1-58c6-6f66ed70e0bd.md "ThermalAssetId Property") | The ElementId of the thermal PropertySetElement. |
| [Transparency](71499d4f-686b-c708-fd87-a3f6523b3189.md "Transparency Property") | The transparency of the material. |
...
| [UseRenderAppearanceForShading](6cba11a1-b384-c588-3e88-526d3229c6c1.md "UseRenderAppearanceForShading Property") | True to use the render appearance settings for shaded view appearance; false to use the material's color and transparency value for shaded view appearance. |
