...
---  
Group Members  
[Group Class](ca54af3c-52d8-0aed-cd22-440ec2584b89.md "Group Class") Methods Properties See Also  
---  
The [Group](ca54af3c-52d8-0aed-cd22-440ec2584b89.md "Group Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetAvailableAttachedDetailGroupTypeIds](dd127374-e2c5-9c5e-3edd-c1b0ec60e30d.md "GetAvailableAttachedDetailGroupTypeIds Method") | Returns the attached detail groups available for this group type. |
...
| [GetMemberIds](42a745b8-dc2e-ef06-0ad3-7e4c775eea9d.md "GetMemberIds Method") | Retrieves all the member ElementIds of the group. |
...
| [GetShownAttachedDetailGroupTypeIds](39290399-a9b1-52ed-cfcf-33c24b9b675c.md "GetShownAttachedDetailGroupTypeIds Method") | Returns the attached detail groups which have displayed instances for this group type in the input view. |
...
| [HideAllAttachedDetailGroups](df7937f2-c48b-8549-a7e2-f2fd1cbafa7b.md "HideAllAttachedDetailGroups Method") | Hides all the available attached detail groups for this element group type that are compatible with the input view type. |
| [HideAttachedDetailGroups](660bd48f-dd60-562c-1935-8fcbd258669a.md "HideAttachedDetailGroups Method") | Hides the element group's attached detail groups of the input group type that are compatible with the input view. |
| [IsCompatibleAttachedDetailGroupType](60562c31-ef34-4cbd-77bc-3fe89a8d2f38.md "IsCompatibleAttachedDetailGroupType Method") | Checks if the orientation of the input attached detail group matches the input view's orientation. |
...
| [ShowAllAttachedDetailGroups](e6c7cae5-a513-e212-8139-20abf9f40ba1.md "ShowAllAttachedDetailGroups Method") | Shows all the available attached detail groups for this element group type that are compatible with the input view type. |
| [ShowAttachedDetailGroups](2e4d7640-92fa-fc3b-83a2-e492bc8b0269.md "ShowAttachedDetailGroups Method") | Shows the element group's attached detail groups of the input group type that are compatible with the input view. |
| ToString | Returns a string that represents the current object. (Inherited from Object.) |
| [UngroupMembers](086b03c7-6a46-a825-1cae-9739a7819d4f.md "UngroupMembers Method") | Ungroups the group. |
...
| [AttachedParentId](52a0655a-26fc-7f2b-17b1-5d48c75dea70.md "AttachedParentId Property") | Indicates the Id of the parent group this group is attached to. |
...
| [GroupType](d77ac466-dc1f-90cb-0b5f-d23fe88065d6.md "GroupType Property") | Get or set the type of the group. |
...
| [IsAttached](fe1c02cc-e67f-2049-8bef-1df2f26fe37d.md "IsAttached Property") | Indicates wether or not this group is attached to a parent group. |
...
| [Location](446dcaea-8792-b703-e0c2-e9e30cbadfd3.md "Location Property") | This property is used to find the physical location of a group within project. (Overrides [Element..::..Location](89438f4f-7e15-835a-0c66-d6adbc8dd00c.md "Location Property").) |
