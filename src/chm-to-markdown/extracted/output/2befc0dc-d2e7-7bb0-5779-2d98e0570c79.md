...
---  
LineLoad Members  
[LineLoad Class](ee5ec273-350a-1cdb-d136-0c454bb1446a.md "LineLoad Class") Methods Properties See Also  
---  
The [LineLoad](ee5ec273-350a-1cdb-d136-0c454bb1446a.md "LineLoad Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetCurve](9c5b8a89-b69e-63a3-b93e-8ee058e92874.md "GetCurve Method") | Returns curve that define geometry of the line load. |
...
| [IsCurveInsideHostBoundaries](4bdb0447-3312-6ce7-08a6-f9a8de84ab3e.md "IsCurveInsideHostBoundaries Method") | Indicates if the curve is inside panel's boundaries or on panel's edges or if the curve is on the member's curve. |
...
| [IsValidHostId](f294365b-5eee-57c0-ad6a-cbdd7bd7637f.md "IsValidHostId Method") | Indicates if the provided host id can host line loads The document containing both the host and the load The id of the analytical element that is about to host a line load True if a line load can be placed on the input host id |
...
| [SetCurve](2066b893-dc5e-7082-adc2-0fef5e397b6e.md "SetCurve Method") | Sets the curve for the line load. |
...
| [SetPoints](41589a19-523d-ab5f-d72e-4e3bd7bc020d.md "SetPoints Method") | Sets start and end point of the line load. |
...
| [EndPoint](55965bc2-8cc9-1609-2a9a-0566e478d97d.md "EndPoint Property") | Returns the three dimensional location of the end point for the line load. |
| [ForceVector1](50cbbc07-492f-b5f3-2753-1da47d52a8db.md "ForceVector1 Property") | The force vector applied to the start point of the line load, oriented according to OrientTo setting. |
| [ForceVector2](3b7d9168-aaa1-9efa-cc74-d384736e62c7.md "ForceVector2 Property") | The force vector applied to the end point of the line load, oriented according to OrientTo setting. |
...
| [IsProjected](482ec1fe-b5f4-75fb-2f17-440a6170aa37.md "IsProjected Property") | Indicates if the load is projected. |
...
| [IsUniform](e315fe82-508c-b64e-0f9a-4863596544f2.md "IsUniform Property") | Indicates if the load is uniform. |
...
| [MomentVector1](0094b002-656b-9c6b-2a9c-9a4d9eb97705.md "MomentVector1 Property") | The moment vector applied to the start point of the line load, oriented according to OrientTo setting. |
| [MomentVector2](ca5f8ab4-f017-81f7-46b9-de5154beaa70.md "MomentVector2 Property") | The moment vector applied to the end point of the line load, oriented according to OrientTo setting. |
...
| [StartPoint](77e175b5-7495-7a20-98fc-6aa5706a7687.md "StartPoint Property") | Returns the three dimensional location of the start point for the line load. |
