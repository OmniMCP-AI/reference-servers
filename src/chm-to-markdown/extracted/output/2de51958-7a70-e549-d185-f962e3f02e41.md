# MultiReferenceAnnotationType Members
...
---  
MultiReferenceAnnotationType Members  
[MultiReferenceAnnotationType Class](046b4d91-40b3-4dd0-be1b-635fb30956c2.md "MultiReferenceAnnotationType Class") Methods Properties See Also  
---  
...
| [DimensionStyleId](2849b4f5-70fd-747b-e31c-d286ee518645.md "DimensionStyleId Property") | The dimension style which will be used by the child dimension of the multi-reference annotation. |
...
| [GroupTagHeads](c8bbdb4c-9c69-b4b8-7382-c3d9f54f380c.md "GroupTagHeads Property") | Controls if parameter values for the annotation's references will be reported in one grouped tag head or if every reference will get its own tag head. |
...
| [ReferenceCategoryId](5d89b166-9eb2-924b-7c8b-ec41508825d0.md "ReferenceCategoryId Property") | The category of elements to which this annotation applies. |
| [ShowDimensionText](48eb0247-c2f6-ea03-b347-f9d999662428.md "ShowDimensionText Property") | Controls if text from the multi-reference annotation's dimension will be shown. |
| [TagTypeId](27b53b40-5506-9a4a-321a-cd8db9b09ceb.md "TagTypeId Property") | The tag type which will be used by the child tag the multi-reference annotation. |
