...
---  
FabricSheetType Members  
[FabricSheetType Class](892f0ce6-5548-d299-c976-9355ac4109ee.md "FabricSheetType Class") Methods Properties See Also  
---  
...
| [CreateDefaultFabricSheetType](20f37de8-a912-d25c-e16e-aa89256e2e90.md "CreateDefaultFabricSheetType Method") | Creates a new FabricSheetType object with a default name. |
...
| [GetReinforcementRoundingManager](bcb66de9-4e74-6ddf-5a01-d2a009d25224.md "GetReinforcementRoundingManager Method") | Returns an object for managing reinforcement rounding override settings. |
...
| [GetWireItem](2cceb1d7-9370-8e64-c2eb-80d8e4083e4b.md "GetWireItem Method") | Gets the Wire stored in the FabricSheetType at the associated index. |
...
| [IsCustom](27448574-3a94-df24-58d9-f12202caa8c6.md "IsCustom Method") | Verifies if the type is Custom Fabric Sheet |
...
| [IsValidMajorLapSplice](6273ad31-b98a-0dd5-ac36-b7e96e23df00.md "IsValidMajorLapSplice Method") | Identifies if the input value is valid to be applied as the major lap splice value for this FabricSheetType. |
| [IsValidMinorLapSplice](9ceacf3d-8ffc-6f9b-ae5e-364efdd2d864.md "IsValidMinorLapSplice Method") | Identifies if the input value is valid to be applied as the minor lap splice value for this FabricSheetType. |
...
| [SetLayoutAsCustomPattern](1544f3ff-e03d-7f32-a1d5-9a51ce7e47e0.md "SetLayoutAsCustomPattern Method") | Sets the minor and major layout patterns as Custom, while specifying the needed parameters for this pattern. |
| [SetMajorLayoutAsActualSpacing](76f4ef42-0dc5-8c84-42dc-27d4898b9ec0.md "SetMajorLayoutAsActualSpacing Method") | Sets the major layout pattern as ActualSpacing, while specifying the needed parameters for this pattern. |
| [SetMajorLayoutAsFixedNumber](67722d68-3d89-6572-a6cd-44924f628089.md "SetMajorLayoutAsFixedNumber Method") | Sets the major layout pattern as FixedNumber, while specifying the needed parameters for this pattern. |
| [SetMajorLayoutAsMaximumSpacing](9d0a435c-4dec-544b-921c-c43b89010c38.md "SetMajorLayoutAsMaximumSpacing Method") | Sets the major layout pattern as MaximumSpacing, while specifying the needed parameters for this pattern. |
| [SetMajorLayoutAsNumberWithSpacing](f90b996d-9897-2822-05df-01e3dd6e0031.md "SetMajorLayoutAsNumberWithSpacing Method") | Sets the major layout pattern as NumberWithSpacing, while specifying the needed parameters for this pattern. |
| [SetMinorLayoutAsActualSpacing](60b34d65-63f4-3e3f-ac8c-8011ce682184.md "SetMinorLayoutAsActualSpacing Method") | Sets the minor layout pattern as ActualSpacing, while specifying the needed parameters for this pattern. |
| [SetMinorLayoutAsFixedNumber](43c7e4cf-b84e-793b-5b4b-2b4d52d384c8.md "SetMinorLayoutAsFixedNumber Method") | Sets the major layout pattern as FixedNumber, while specifying the needed parameters for this pattern. |
| [SetMinorLayoutAsMaximumSpacing](f2923888-3c22-97fa-13bf-c5b9affb12fa.md "SetMinorLayoutAsMaximumSpacing Method") | Sets the major layout pattern as MaximumSpacing, while specifying the needed parameters for this pattern. |
| [SetMinorLayoutAsNumberWithSpacing](26e9f566-af82-f06f-1a72-25e6eb19fc0b.md "SetMinorLayoutAsNumberWithSpacing Method") | Sets the major layout pattern as NumberWithSpacing, while specifying the needed parameters for this pattern. |
