...
---  
Railing Members  
[Railing Class](4af1265f-859e-123b-ada5-a479324f3dee.md "Railing Class") Methods Properties See Also  
---  
The [Railing](4af1265f-859e-123b-ada5-a479324f3dee.md "Railing Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Flip](ad8cbb52-9732-6aaf-1187-1731f6116e81.md "Flip Method") | Flips the railing. |
...
| [GetHandRails](7c33a83c-7114-6caf-16eb-275e0c98c330.md "GetHandRails Method") | Get all the handrails of the railing. |
...
| [GetMultistoryStairsPlacementLevels](aac188d3-7c62-e74c-3579-cdcb8dc5c7f3.md "GetMultistoryStairsPlacementLevels Method") | Gets the ids of the base levels of the stairs upon which this railing is placed. |
...
| [GetPath](70531de6-1d62-d37f-2b20-721cc68d2f9e.md "GetPath Method") | Gets the railing path. |
...
| [GetSubelementOnLevel](b9d35dc7-42d9-1699-4985-bc80fe2c7045.md "GetSubelementOnLevel Method") | Gets the subelement on given level. |
...
| [IsValidHostForNewRailing](cc1aaa43-f61a-e65d-eac9-43370200295a.md "IsValidHostForNewRailing Method") | Checks whether new railing can be created and placed on the specified host. |
| [IsValidPathForRailing](3f368fef-e0ac-1430-d409-1fa5136d1b8f.md "IsValidPathForRailing Method") | Checks whether a railing can be created along a railing path. |
...
| [RailingCanBeHostedByElement](7f73d2b0-b1ad-9070-4330-6c9d7f28a835.md "RailingCanBeHostedByElement Method") | Checks whether the specified element can be used as a host for the railing. The host can be: |
...
| [RemoveHost](28367859-53d5-fbbe-2d55-16970e62e9b4.md "RemoveHost Method")|  Removes the association between the railing and its host.   
| [Reset](fc09d693-e4f2-8971-cb2d-b64cd6325227.md "Reset Method")|  Resets the railing to the default one that the system generates.   
| [ResetSupportPosition](89c19f58-4556-ecb6-1110-ff69e55436b4.md "ResetSupportPosition Method")|  Resets the continuous rails support subelements position data.   
...
| [SetMultistoryStairsPlacementLevels](47227a43-299a-e762-1e2a-acafb14093a3.md "SetMultistoryStairsPlacementLevels Method")|  Sets the ids of the base levels of the stairs upon which this railing is placed.   
| [SetPath](2a1c1870-31f9-c80d-23b4-da44d0e86179.md "SetPath Method")|  Sets the railing path.   
...
| [CanReset](a1ae830a-9923-a134-1f72-fff811863974.md "CanReset Property") | True if the railing can be reset, False otherwise. |
...
| [Flipped](3e0d0aea-7bfc-ac33-405e-2e26cbdc6e8f.md "Flipped Property") | Indicates if the railing is flipped. |
...
| [HasHost](c977dcea-a003-cd92-5381-91efe270d055.md "HasHost Property") | Indicates if the railing has a host. |
| [HostId](4fe4b0e6-591d-70d1-10f7-e192393fae26.md "HostId Property") | The host of the railing. |
...
| [IsDefault](03ee5975-6d93-f6d1-0c6f-ab31c0331f34.md "IsDefault Property") | Indicates if the railing is the default one that system generates. |
...
| [TopRail](2cde1842-b57b-6864-2f4a-c4852303a152.md "TopRail Property") | The top rail of the railing. |
