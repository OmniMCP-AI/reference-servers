...
Revit 2024 API  
---  
BeamSystem..::..Create Method (Document, IList<(Of <(<'Curve>)>)>, SketchPlane, Int32)  
...
curveIndexForDirection
    Type: System..::..Int32 Index of the curve in the profile to be used as direction. '0' means the default direction-to use the first curve in profile. The curve from the profile to be used as direction must be a Line. 
# ### Return Value
