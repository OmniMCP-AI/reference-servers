# CreateSingleCategorySchedule Method (Document, ElementId, ElementId)
...
Revit 2024 API  
---  
AssemblyViewUtils..::..CreateSingleCategorySchedule Method (Document, ElementId, ElementId)  
...
| --- | --- |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md "ArgumentException Class") | assemblyInstanceId is not an AssemblyInstance. -or- scheduleCategoryId is not a valid category for a regular schedule. |
