# SetSuperscriptStatus Method (TextRange, Boolean)
...
Revit 2024 API  
---  
FormattedText..::..SetSuperscriptStatus Method (TextRange, Boolean)  
...
isSuperscript
    Type: System..::..Boolean The desired superscript status of characters in the given text range. True to set superscript, false to set not superscript. 
# Remarks
