...
---  
```text
Public Shared Function GetInsulationIds ( _
...
| --- | --- |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md "ArgumentException Class") | This id does not represent a valid host for insulation. |
