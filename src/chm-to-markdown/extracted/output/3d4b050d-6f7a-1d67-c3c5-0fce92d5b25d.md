...
---  
ReferencePlane Members  
[ReferencePlane Class](e7003ec7-1dbe-50a2-fb3d-a83a5a3b5b9f.md "ReferencePlane Class") Methods Properties See Also  
---  
The [ReferencePlane](e7003ec7-1dbe-50a2-fb3d-a83a5a3b5b9f.md "ReferencePlane Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddLeader](0373eec6-5963-b036-e816-de4d93f2f5f1.md "AddLeader Method") | Adds a default Leader for the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders).  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [CanBeVisibleInView](88545b41-8cd2-521a-748c-94967a66dc72.md "CanBeVisibleInView Method") | Checks if the datum plane can be visible in the view.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [Flip](1d78d335-f717-555d-e99f-f44e3d0376ce.md "Flip Method") | Flips the orientation of the reference plane. |
| [GetCurvesInView](2f93dd88-baac-8e61-377e-b937f3faaff6.md "GetCurvesInView Method") | Gets a collection of curves representing the DatumPlane element in the given view.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
| [GetDatumExtentTypeInView](b3498ccf-1180-e0fd-502c-6c767f5b42cc.md "GetDatumExtentTypeInView Method") | Identifies whether the curve representing the datum plane is displayed according to its actual 3d extents, or else according to a view specific setting.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [GetLeader](4f5ebf97-8a85-bd5b-0edd-f2f0f6b18cb2.md "GetLeader Method") | Gets a copy of the leader applied to the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders).  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [GetPlane](a37ce3cd-aff7-6394-5b13-e2484550e511.md "GetPlane Method") | Returns the geometry plane to which the reference plane is assigned. |
| [GetPropagationViews](ecfed956-7434-0c33-6ab0-0bc80bd2a157.md "GetPropagationViews Method") | Gets a list of candidate views which are parallel to the current view and to which the extents of the datum may be propagated.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
| [GetReference](825a593b-4acc-c2ad-9df7-b281a3a2575b.md "GetReference Method") | Returns the geometry reference of the reference plane. |
...
| [HasBubbleInView](c216fb35-eb3b-6097-e866-989dfb1d433e.md "HasBubbleInView Method") | Identifies if the DatumPlane has bubble or not.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [HideBubbleInView](1349dc55-fbac-f114-f94d-42fc5fc10b1f.md "HideBubbleInView Method") | Hides the bubble in a view. This method does not apply to Reference planes.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
| [IsBubbleVisibleInView](75c39be6-5f78-9dd2-061e-13b846e739d5.md "IsBubbleVisibleInView Method") | Identifies if the bubble is visible or not in a view.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [IsCurveValidInView](2fb3c757-0555-d2ba-2cd2-9399bf238735.md "IsCurveValidInView Method") | Checks if the curve is valid to be as the extents for the datum plane in a view. The curve must be bound and coincident with the original one of the datum plane.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [IsLeaderValid](321a1f1a-61ef-3e7a-e87a-47d4cd4fd014.md "IsLeaderValid Method") | Identifies if the leader valid or not for this DatumPlane. This method does not apply to Reference planes (which do not support leaders).  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [Maximize3DExtents](231447e9-0963-fe1d-8177-d8ac136f835d.md "Maximize3DExtents Method") | Computes the 3d extents of all model geometry and levels, and extends the 3d extents of this datum surface to include the model extents.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
| [PropagateToViews](4512810a-93c3-d127-6197-94da427d54a2.md "PropagateToViews Method") | Propagates the extents applied to this datum in the view to the specified parallel views.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [SetCurveInView](eaff0038-34f2-03cf-185b-2872cffb84af.md "SetCurveInView Method") | Sets the extents to match the curve.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
| [SetDatumExtentType](6509627e-dda7-4d3d-eddf-4ed462a1f68c.md "SetDatumExtentType Method") | Sets whether the curve representing the datum plane is displayed according to its 3d extents, or else according to a view specific setting.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [SetLeader](a771f300-9d74-3ed7-ba1b-b0961e6c36b3.md "SetLeader Method") | Sets the leader to the indicated end of the datum plane. This method does not apply to Reference planes (which do not support leaders).  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
| [ShowBubbleInView](e8bbbf7f-38d2-d818-1738-17d844b96162.md "ShowBubbleInView Method") | Shows the bubble in a view. This method does not apply to Reference planes.  (Inherited from [DatumPlane](3e0a6725-ee40-c4d5-839f-b7720c1fe2af.md "DatumPlane Class").) |
...
| [BubbleEnd](893cba06-2611-bf41-5f59-f5f2959721c7.md "BubbleEnd Property") | The bubble end of the reference plane. |
...
| [Direction](8cccbf85-b619-1ded-633d-b75ca403b48a.md "Direction Property") | The direction of the reference plane. |
...
| [FreeEnd](5e62a93d-fc60-35fa-ea6a-007f57cde1b2.md "FreeEnd Property") | The free end of the reference plane. |
...
| [Name](9026faa7-b77c-c9e3-b33c-818492decaa7.md "Name Property") | The name property of the reference plane. |
| [Normal](81807bea-c248-31ae-e28f-a9edc50e9ce1.md "Normal Property") | The normal vector of the reference plane. |
