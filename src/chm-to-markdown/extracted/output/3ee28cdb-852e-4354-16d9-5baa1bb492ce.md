# StructuralConnectionHandler Members
...
---  
StructuralConnectionHandler Members  
[StructuralConnectionHandler Class](78653026-36f1-6ab3-f2c0-728692c99b3c.md "StructuralConnectionHandler Class") Methods Properties See Also  
---  
The [StructuralConnectionHandler](78653026-36f1-6ab3-f2c0-728692c99b3c.md "StructuralConnectionHandler Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddElementIds](707dc3c9-bd26-65b2-14ae-2e345c5ad977.md "AddElementIds Method") | Adds element ids to the connection. All element ids in an array should be of applicable category. |
| [AddReferences](e3df730c-4e40-92ee-714c-f2beae290839.md "AddReferences Method") | Adds references to the connection. All references should be of applicable category. |
...
| [CreateGenericConnection](887e1ee2-72cd-b3f4-0d1b-e3cfc82b0f07.md "CreateGenericConnection Method") | Creates a new instance of a Structural Connection Handler with a generic type, which defines the connection between given elements. |
...
| [GetConnectedElementIds](0c30ce4f-eef8-fd20-529f-c7b0983998dc.md "GetConnectedElementIds Method") | Retrieves list of element ids of connected elements. |
...
| [GetInputPoint](c7a4dc5e-bc26-0987-4995-2c5d2dbcee70.md "GetInputPoint Method") | Returns point with specified id. Returns null if specified point does not exist |
| [GetInputPoints](1b74c240-55f5-c1ab-1e78-57bba4090a66.md "GetInputPoints Method") | Returns a list of additional points defining certain connections. |
| [GetInputReferences](64f39922-a906-19ae-bfa0-0642910eefdb.md "GetInputReferences Method") | Gets references of input elements. |
...
| [GetOrigin](de922052-21bc-5958-8c4b-d4398ead0a88.md "GetOrigin Method") | Retrieves origin point of Structural Connection Handler element. |
...
| [IsCustom](f0a922df-ec34-9170-0963-86edc9243628.md "IsCustom Method") | Checks if Structural Connection Handler has the custom connection style. |
...
| [IsDetailed](218fb7c4-0752-74ea-2403-82f24b235e00.md "IsDetailed Method") | Checks if Structural Connection Handler has the detailed connection style. |
...
| [RemoveElementIds](ae145719-5699-3f78-d995-981319b4703f.md "RemoveElementIds Method") | Removes element ids from the connection. All element ids in an array should belong to the connection. |
| [RemoveReferences](aded3846-21ad-e351-5c2a-c7bbfe1b0682.md "RemoveReferences Method") | Removes references from the connection. All references in an array should belong to the connection. |
| [SetDefaultElementOrder](7b74ec8e-5790-0caa-5045-ef0ff72128fc.md "SetDefaultElementOrder Method") | Sorts the connected elements connection according to structural categories, element materials and geometries. The steel element is set rather than an element of other material. The priorities of the elements are set according structural categories in following order: columns, framings, walls, foundations, floors. In case of several Structural Framing elements order is determined by cutting - the cutting element is set as the primary one rather than element being cut. |
...
| --- | --- |
| --- | --- | --- |
| [ApprovalTypeId](5257d862-ab65-0c35-bdb8-b6b69b627122.md "ApprovalTypeId Property") | Retrieves or changes approval type of the Structural Connection Handler. |
...
| [CodeCheckingStatus](2f3f13cf-6064-1b99-332e-c4d8f83e9ec1.md "CodeCheckingStatus Property") | Code checking status of the structural connection. |
...
| [OverrideTypeParams](a856e3e4-892a-104a-d87c-aadf12887abe.md "OverrideTypeParams Property") | Allow or disallow connection's type parameters to be overridden. |
...
| [SingleElementEndIndex](2d7a6f59-79d8-d628-160b-e78365966c9f.md "SingleElementEndIndex Property") | Element end index for single element connections (0: start, 1: end). |
