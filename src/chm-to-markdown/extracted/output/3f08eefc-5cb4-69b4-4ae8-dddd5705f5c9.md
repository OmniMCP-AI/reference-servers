...
Revit 2024 API  
---  
ParameterTypeId..::..DebugtabDataboundcontrolsdemoInteger Property   
...
---  
```text
Public Shared ReadOnly Property DebugtabDataboundcontrolsdemoInteger As ForgeTypeId
	Get
```
...
```text
public:
static property ForgeTypeId^ DebugtabDataboundcontrolsdemoInteger {
	ForgeTypeId^ get ();
}
```
