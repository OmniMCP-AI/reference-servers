...
---  
DimensionType Members  
[DimensionType Class](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md "DimensionType Class") Methods Properties See Also  
---  
The [DimensionType](a6f6655d-3383-a0ea-670d-0bbe6d2bb964.md "DimensionType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanHaveEqualityFormula](eda97893-d225-4564-471d-dd2f1a4277e5.md "CanHaveEqualityFormula Method") | Checks whether this DimensionType can have an equality formula. |
| [CanHaveOrdinateDimensionSetting](aaab2cfd-af6c-9ef4-2754-91f2be6ee5bd.md "CanHaveOrdinateDimensionSetting Method") | Checks whether this DimensionType can have an ordinate dimension settings. |
...
| [GetAlternateUnitsFormatOptions](81fca2c9-ca3c-0f70-366e-8841944bdac7.md "GetAlternateUnitsFormatOptions Method") | Gets the FormatOptions to optionally override the default settings in the Units class for the alternate units value. |
...
| [GetEqualityFormula](086fb666-7be0-f093-516e-670b149be97d.md "GetEqualityFormula Method") | Gets an ordered list of the entries in the equality formula definition. |
...
| [GetOrdinateDimensionSetting](97c6109a-f5af-eccf-5db7-2a72f608b685.md "GetOrdinateDimensionSetting Method") | Gets the ordinate dimension settings for this DimensionType. |
...
| [GetSpecTypeId](bcdcd878-9956-0531-deac-e68dd6f7149a.md "GetSpecTypeId Method") | Gets the spec of this dimension style. |
...
| [GetUnitsFormatOptions](ca121374-9437-d76c-06e8-7a98d16829fd.md "GetUnitsFormatOptions Method") | Gets the FormatOptions to optionally override the default settings in the Units class for the units value. |
...
| [SetAlternateUnitsFormatOptions](a8203fee-0893-99fe-a279-950b80cd22ee.md "SetAlternateUnitsFormatOptions Method") | Sets the FormatOptions to optionally override the default settings in the Units class for the alternate units value. |
...
| [SetEqualityFormula](1fbbcd04-ce47-e054-6ed7-706171f97ec0.md "SetEqualityFormula Method") | Sets an ordered list of the entries to use in the equality formula definition. |
| [SetOrdinateDimensionSetting](b6201e90-b02d-a2a0-a239-9230f79e8a20.md "SetOrdinateDimensionSetting Method") | Sets the ordinate dimension settings for this DimensionType. |
| [SetUnitsFormatOptions](3589c9ad-24df-58ca-07a1-2b0c3e2ac157.md "SetUnitsFormatOptions Method") | Sets the FormatOptions to optionally override the default settings in the Units class for the units value. |
...
| --- | --- |
| --- | --- | --- |
| [AlternateUnits](c6e3383f-be38-6738-5d7e-18487fa01de5.md "AlternateUnits Property") | The alternate units display mode for this DimensionType. |
| [AlternateUnitsPrefix](c2e2e6e4-4042-ca9d-e537-8d7430e621c9.md "AlternateUnitsPrefix Property") | The prefix text for the alternate units value. |
| [AlternateUnitsSuffix](fc89169d-afb1-55e4-c8c0-98fab0f097ef.md "AlternateUnitsSuffix Property") | The suffix text for the alternate units value. |
...
| [Prefix](8bc987fd-a5f3-9c11-e9be-860947445f81.md "Prefix Property") | The prefix text for the dimension value. |
| [StyleType](2c31c41a-cd12-4fef-2b2e-439012efc810.md "StyleType Property") | The dimension style type of this DimensionType. |
| [Suffix](1caee7d4-8990-7790-f41b-fb03166d7c58.md "Suffix Property") | The suffix text for the dimension value. |
