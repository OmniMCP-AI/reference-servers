...
---  
CurveElement Members  
[CurveElement Class](61673852-2d08-003d-e9fd-4be89d533774.md "CurveElement Class") Methods Properties See Also  
---  
The [CurveElement](61673852-2d08-003d-e9fd-4be89d533774.md "CurveElement Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CreateAreaBasedLoadBoundaryLine](71384e53-8fc6-faad-b0fa-616f3d692f34.md "CreateAreaBasedLoadBoundaryLine Method") | Creates an area based load boundary line. |
| [CreateAreaBasedLoadBoundaryLines](aee4c63d-0894-39d4-560f-971bd29bf948.md "CreateAreaBasedLoadBoundaryLines Method") | Creates area based load boundary lines. |
...
| [GetAdjoinedCurveElements](5f3eaf8b-047e-d287-49a9-8777af3a67da.md "GetAdjoinedCurveElements Method") | Returns elements that are joining with this curve element at the given end point. |
| [GetAreaBasedLoadBoundaryLineData](a99e772c-9f79-c81f-14ec-71703e19676e.md "GetAreaBasedLoadBoundaryLineData Method") | Gets the area based load boundary line data from this curve, if applicable. |
...
| [GetLineStyleIds](3e30d0b4-6c74-18bf-043f-2430ff9ac17b.md "GetLineStyleIds Method") | Ids of all line style Elements that are applicable to this curve element. |
...
| [GetTangentLock](7544e419-0805-5c12-8c12-9599e1b16065.md "GetTangentLock Method") | Returns the state of a tangent join between this and another curve element at the given end-point. |
...
| [HasTangentJoin](a7b2da39-2bab-5cea-5441-eb3ad476a81f.md "HasTangentJoin Method") | Tests whether this curve element and the input curve element have common tangent join at the given end-point. |
| [HasTangentLocks](1be690bc-28ee-5d33-b253-7835c35cb158.md "HasTangentLocks Method") | Tests whether this curve element has any locked tangent joins at the given end-point. |
| [IsAdjoinedCurveElement](c72d52bd-4ca6-c3ea-1666-436d3f317456.md "IsAdjoinedCurveElement Method") | This method tests whether this and the given curve elements are joined at the given end. |
...
| [SetGeometryCurve](9deec90c-4efc-9aa6-245d-061669022aa2.md "SetGeometryCurve Method") | Sets the geometry of the curve element. After the curve geometry is set, other nearby curves may join to the new curve geometry. |
| [SetSketchPlaneAndCurve](99c03261-aeb7-032f-d71e-1e03716cbfb3.md "SetSketchPlaneAndCurve Method") | Sets the sketch plane and the curve for this CurveElement. |
| [SetTangentLock](34e01fde-176d-c53b-1a9e-bda92dbdf142.md "SetTangentLock Method") | Sets a new status for an existing tangent join with another curve element at the given end-point. |
...
| [CenterPointReference](8e17164e-f2d0-828d-8fe2-9720fec91303.md "CenterPointReference Property") | Centerpoint reference of curve element. Curves such as circles, arcs, ellipses, and partial ellipses support this property. |
...
| [CurveElementType](0d8763e7-6d5b-bdb9-c4a7-d19c63f53dc9.md "CurveElementType Property") | Type of the curve element. |
...
| [GeometryCurve](713ec948-c85c-24fa-0668-c2c2bbdc4c73.md "GeometryCurve Property") | Geometry curve of the curve element. |
...
| [LineStyle](691e64a2-e5ea-b619-4362-1a2c17e23b2f.md "LineStyle Property") | The line style of this curve element. |
...
| [SketchPlane](e8c6a9e9-e048-d750-2951-6f45ac7f350d.md "SketchPlane Property") | The sketch plane the curve element lies in. |
| [SupportsTangentLocks](b0fded94-12f7-963f-5e1b-7a67d8bc7ba3.md "SupportsTangentLocks Property") | Indicates whether or not this curve element can have a locked tangent join at either of its end-points shared with another curve element. |
