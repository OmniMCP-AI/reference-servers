...
---  
Opening Members  
[Opening Class](720de864-9f4e-c606-c7f4-2e7a0b2da46f.md "Opening Class") Methods Properties See Also  
---  
The [Opening](720de864-9f4e-c606-c7f4-2e7a0b2da46f.md "Opening Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [BoundaryCurves](48230156-1a98-ed16-3983-babdfc0ded18.md "BoundaryCurves Property") | The geometry information for non-rectangular openings in project documents, or for all openings in family documents. |
| [BoundaryRect](2ae871c2-8335-3ceb-a529-48a791e851c5.md "BoundaryRect Property") | Retrieves the geometry information if the opening boundary is a rect. |
...
| [Host](6f603c8c-7644-4d71-a6d2-e3bca22b6c27.md "Host Property") | Retrieves the host element of this opening. |
...
| [IsRectBoundary](572ba4b4-d9cf-fecc-3066-efb53000db3d.md "IsRectBoundary Property") | Retrieves the information whether the opening has a rectangular boundary. |
...
| [IsTransparentIn3D](e467d103-7db0-b6c6-efe7-e231ffcf1b07.md "IsTransparentIn3D Property") | Indicates if the opening is transparent in 3D view when loaded into the project. |
| [IsTransparentInElevation](459c0080-ccf3-41d8-9370-1f2df4042876.md "IsTransparentInElevation Property") | Indicates if the opening is transparent in elevation view when loaded into the project. |
...
| [SketchId](91ed6571-13b3-fa4c-d1c3-624e1cbd73f9.md "SketchId Property") | Returns id of the Sketch or invalidElementId if element deon't own the Sketch. |
