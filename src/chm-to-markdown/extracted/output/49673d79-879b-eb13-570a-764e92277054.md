...
---  
HostedSweep Members  
[HostedSweep Class](e0744068-e808-4547-3743-81be0a4adcbc.md "HostedSweep Class") Methods Properties See Also  
---  
The [HostedSweep](e0744068-e808-4547-3743-81be0a4adcbc.md "HostedSweep Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddSegment](c26f908b-140a-6f06-918d-263efe814df9.md "AddSegment Method") | Add segments to the hosted sweep object. |
...
| [GetEndPointParameter](9d932372-7418-6e37-6764-0cc0994959df.md "GetEndPointParameter Method") | Retrieve segment's start point or end point parameter. |
...
| [HorizontalFlip](c64cb45b-74b9-acef-db86-62931b11b1ee.md "HorizontalFlip Method") | Flip the hosted sweep object along horizontal line. |
...
| [RemoveSegment](14ff1a00-0fd1-cc28-a20f-9e3b00083488.md "RemoveSegment Method") | Remove segments from the hosted sweep object. |
| [SetEndPointParameter](de365ff6-a402-a803-43de-c9efc847fccd.md "SetEndPointParameter Method") | Set segment's start point or end point parameter. |
...
| [VerticalFlip](481bf9a1-1437-9da7-0589-35d7bb9d7428.md "VerticalFlip Method") | Flip the hosted sweep object along vertical line. |

# Properties
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [Angle](beb95fa6-6296-2631-f30c-1fc71b3b03c5.md "Angle Property") | Retrieve/set the angle of the hosted sweep object relative its references (Unit : Radian). |
...
| [HorizontalFlipped](bf5a61c7-e8d5-631d-749a-659084be1723.md "HorizontalFlipped Property") | Retrieve the horizontal flip status of the hosted sweep object. |
| [HorizontalOffset](a7da1c98-55e0-b0eb-fbf4-165d7d424924.md "HorizontalOffset Property") | Retrieve/set the horizontal offset of the hosted sweep object. |
...
| [Length](5f5119d2-7b2f-1a17-0ba3-ef74cbe984e9.md "Length Property") | Retrieve the length of the hosted sweep object. |
...
| [ReferenceCurve](76c8b986-670c-1d4a-3ae4-776b3eb29ad9.md "ReferenceCurve Property") | The curve on which the hosted sweep segment is created. |
...
| [VerticalFlipped](3919a432-3aed-5230-b89a-2346d2f769ca.md "VerticalFlipped Property") | Retrieve the vertical flip status of the hosted sweep object. |
| [VerticalOffset](8b3de2d4-3005-afc9-cbc5-1862fd60341e.md "VerticalOffset Property") | Retrieve/set the vertical offset of the hosted sweep object. |
