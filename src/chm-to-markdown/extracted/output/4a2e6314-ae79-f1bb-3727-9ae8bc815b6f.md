# SetProjectionLinePatternId Method
...
---  
```text
Public Function SetProjectionLinePatternId ( _
...
# ### Parameters
linePatternId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") ElementId of the projection surface line pattern for the override. InvalidElementId means no override is set. 
# ### Return Value
