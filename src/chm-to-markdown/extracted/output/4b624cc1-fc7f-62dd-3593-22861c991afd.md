...
Revit 2024 API  
---  
ReferenceIntersector Constructor (ICollection<(Of <(<'ElementId>)>)>, FindReferenceTarget, View3D)  
...
```text
Public Sub New ( _
	targetElementIds As ICollection(Of ElementId), _
...
# ### Parameters
targetElementIds
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class")>)>)> The target element ids. 
targetType
