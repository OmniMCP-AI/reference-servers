...
---  
FlexPipe Members  
[FlexPipe Class](4b0e0656-4760-4a91-a777-ce50869a827a.md "FlexPipe Class") Methods Properties See Also  
---  
The [FlexPipe](4b0e0656-4760-4a91-a777-ce50869a827a.md "FlexPipe Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [IsFlexPipeTypeId](5078748d-39a2-f720-0982-8b550cc43361.md "IsFlexPipeTypeId Method") | Checks if given type is valid flexible pipe type. |
...
| [IsPipingSystemTypeId](89bd462f-a178-5c9b-a897-44423c97bd2d.md "IsPipingSystemTypeId Method") | Checks if given type is valid piping system type. |
...
| [EndTangent](fa54b3c9-d87c-014b-6bc7-f38ef05cf5bd.md "EndTangent Property") | Gets or sets the tangent vector at the end of the curve. The invalid or zero vector is ignored when setting the tangent. |
| [FlexPipeType](5b7ab8d0-bd8d-f834-5d2e-a2504d3a91ce.md "FlexPipeType Property") | The flex pipe type of this flex pipe. |
| [FlowState](5f2838c6-d4ed-24fc-a79e-134c1e62cfd3.md "FlowState Property") | The flow state of the pipe. |
...
| [Points](8aac116b-26f3-061a-6cff-fd0bcb0be110.md "Points Property") | The points of the flex pipe. |
...
| [StartTangent](6ec88166-0a20-e0cc-da8e-bc74d27709ea.md "StartTangent Property") | Gets or sets the tangent vector at the start of the curve. The invalid or zero vector is ignored when setting the tangent. |
