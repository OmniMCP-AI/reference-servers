...
---  
```text
public static FailureDefinitionId ShapeFailure { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property ShapeFailure As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ ShapeFailure {
