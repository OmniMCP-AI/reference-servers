...
---  
SunAndShadowSettings Members  
[SunAndShadowSettings Class](d616614b-a2ed-b0d0-4f11-f0a0b54a22e5.md "SunAndShadowSettings Class") Methods Properties See Also  
---  
...
| [CalculateTimeZone](2206c828-d85c-d54b-73f1-471e67a3ce36.md "CalculateTimeZone Method") | Use Revit's utilities to calculate the time zone for a given longitude and latitude. |
...
| [FitToModel](b9de8188-ffe3-407c-102e-850e92977a32.md "FitToModel Method") | Adjust SunAndShadowSettings to fit around the current model geometry. |
| [GetActiveSunAndShadowSettings](172fb455-c62c-7baf-6d11-a458a1c9b725.md "GetActiveSunAndShadowSettings Method") | Returns the current SunAndShadowSettings element assigned to the active view for the supplied document. |
...
| [GetFrameAltitude](6150a802-4969-342a-4b5b-0bc7834f0fa0.md "GetFrameAltitude Method") | Identifies the altitude of the sun (angle in radians) for a specific frame. |
| [GetFrameAzimuth](e0eea2bf-5dd0-4337-46c1-fb9755c47457.md "GetFrameAzimuth Method") | Identifies the azimuth of the sun (angle in radians) for a specific frame. |
| [GetFrameTime](59465c30-c6a5-d5a7-0d40-0c05ea64b60d.md "GetFrameTime Method") | Identifies the date and time of the SunAndShadowSettings element for a given frame. |
...
| [GetMatchingPreset](fb84ce23-7f06-bac4-aec4-d63890b10597.md "GetMatchingPreset Method") | Finds the name of the 'per-document' SunAndShadowSettings that matches the properties of this per-view element. |
...
| [GetSunrise](5ed2edef-f53c-0fcb-010d-f4a33d685fba.md "GetSunrise Method") | Identifies the sunrise time for the SunAndShadowSettings element at its current location and indicated date. |
| [GetSunset](a8f1a800-1d06-b994-09f7-fc94474416b0.md "GetSunset Method") | Identifies the sunset time for the SunAndShadowSettings element at its current location and indicated date. |
...
| [IsAfterStartDateAndTime](7ab7d45b-eea2-5559-d003-74cd29aa6955.md "IsAfterStartDateAndTime Method") | Checks whether the end date and time is valid. |
| [IsBeforeEndDateAndTime](e67696b5-0ad9-42f6-c58c-ae65f71c8754.md "IsBeforeEndDateAndTime Method") | Checks whether the start date and time is valid. |
...
| [IsFrameValid](998481b3-00fe-dbe9-1152-10466d565753.md "IsFrameValid Method") | Checks whether the frame is valid for the supplied SunAndShadowSettings. |
| [IsGroundPlaneLevelValid](55c05757-98af-05dd-24c3-9793d595af51.md "IsGroundPlaneLevelValid Method") | Checks whether the element represents a valid Ground Plane level. |
...
| [IsTimeIntervalValid](74661a1d-f8c1-1929-cb22-e8407ca1e1bc.md "IsTimeIntervalValid Method") | Checks whether the time interval is valid for the SunAndShadowType. |
