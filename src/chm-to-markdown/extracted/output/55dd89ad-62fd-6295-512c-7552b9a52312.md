...
Revit 2024 API  
---  
ElementParameterFilter Constructor (IList<(Of <(<'FilterRule>)>)>, Boolean)  
...
inverted
    Type: System..::..Boolean True if the filter should match all elements which do not pass the filter rules. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
