# ELASeparationLinesOverlap Property
...
---  
```text
public static FailureDefinitionId ELASeparationLinesOverlap { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property ELASeparationLinesOverlap As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ ELASeparationLinesOverlap {
