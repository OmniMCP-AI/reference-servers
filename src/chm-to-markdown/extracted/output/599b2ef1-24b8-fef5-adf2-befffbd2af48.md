...
---  
IndependentTag Members  
[IndependentTag Class](e52073e2-9d98-6fb5-eb43-288cf9ed2e28.md "IndependentTag Class") Methods Properties See Also  
---  
The [IndependentTag](e52073e2-9d98-6fb5-eb43-288cf9ed2e28.md "IndependentTag Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddReferences](333fc505-2f6b-e754-6841-fb7f7639284e.md "AddReferences Method") | Adds the provided list of references to the tag's list of references. |
...
| [CanLeaderEndConditionBeAssigned](83343fd7-5244-12ae-faa0-3fcf082d483e.md "CanLeaderEndConditionBeAssigned Method") | Checks whether the LeaderEndCondition can be changed. |
...
| [GetLeaderElbow](cb3f9617-d5a4-7c45-1686-d7c2f60effad.md "GetLeaderElbow Method") | Returns the position of the elbow of the tag's leader that points to specified reference. Position of leader's elbow. |
| [GetLeaderEnd](d6f69738-aa40-d45c-5ab5-ba02d55d0837.md "GetLeaderEnd Method") | Returns the end position of the tag's leader that points to specified reference. |
...
| [GetTaggedElementIds](43260944-f46c-d5df-c9ea-f3a44e24d1a2.md "GetTaggedElementIds Method") | Returns a set of LinkElementId for all tagged elements, if any. A LinkElementId will be provided for each subelement that is being referenced by the tag. |
...
| [GetTaggedLocalElements](f238e2c7-e184-172c-546a-7dd694857e56.md "GetTaggedLocalElements Method") | Get the tagged local elements, if any. An Element will be provided for each subelement that is being referenced by the tag. |
| [GetTaggedReferences](63a90870-6b37-57b2-26fe-6fa1e605a9da.md "GetTaggedReferences Method") | Get the host references of the tag. An array of all the tagged references. |
...
| [HasLeaderElbow](f4febfed-3134-a5c0-0f8e-d4e6c5b4b675.md "HasLeaderElbow Method") | Whether the tag's leader that points to the reference has an elbow point or not. |
...
| [HasTagBehavior](fadc39b4-eb80-2e00-f9af-e5752a0bb498.md "HasTagBehavior Method") | Checks if the IndependentTag has a tag behavior. |
...
| [IsLeaderVisible](8ad822df-1fb8-938f-66d4-60ade8983c40.md "IsLeaderVisible Method") | Returns if leader that points to specified reference is visible or not. |
...
| [IsTaggedOnSubelement](8f6f8b8c-1b1b-1141-e165-1eecd4b765a1.md "IsTaggedOnSubelement Method") | Returns true if the any of the tagged references is a subelement. |
...
| [RemoveReferences](902f7f27-964e-d7cd-e582-07f45750d768.md "RemoveReferences Method") | Removes the provided list of references from the tag's list of references. |
...
| [SetIsLeaderVisible](b0b7f9bc-163b-01a6-9a8c-fa7cfc6c61a0.md "SetIsLeaderVisible Method") | Set tag's leader that points to specified reference to be visible or not. This option can be set only if the LeadersPresentationMode is ShowSpecificLeaders. |
| [SetLeaderElbow](dd5a7d21-cb13-d3d7-6dd6-8e8e427e4873.md "SetLeaderElbow Method") | Set the position of the elbow of the tag's leader that points to specified reference. If this tag is a multileader tag and the elbows are merged, the input position will be set to all leaders. |
| [SetLeaderEnd](fb54c007-6873-68f4-4772-e777609a441b.md "SetLeaderEnd Method") | Set the end position of the tag's leader that points to specified reference. |
...
| [HasLeader](ce3fe3a9-4048-3b29-4dcb-57ca86de4267.md "HasLeader Property") | Identifies if a tag has at least one visible leader, or if all leaders are hidden. |
...
| [IsMaterialTag](7670e365-227c-bc9d-a4b0-c77f793034e2.md "IsMaterialTag Property") | Identifies if it is a material tag or not. |
...
| [IsMulticategoryTag](91f6e4f0-6a6b-efa6-5730-ea32a5cb203c.md "IsMulticategoryTag Property") | Identifies if it is a multi-category tag or not. |
| [IsOrphaned](4906fa9c-e424-92e7-0b7e-15389726ca78.md "IsOrphaned Property") | Identifies if the tag is orphaned or not. |
...
| [LeaderEndCondition](0b0575d6-446d-d3e8-3ef7-12faed553b20.md "LeaderEndCondition Property") | The leader end condition of the tag, such as if the end of the leader is attached to the host or free floating. |
| [LeadersPresentationMode](f0d5e29e-0407-cdc0-cdf7-69ea516bd632.md "LeadersPresentationMode Property") | Identifies the Presentation Mode that is applied to tag leaders. |
...
| [MergeElbows](5c5ad800-7512-be12-dc1a-ebcda5513622.md "MergeElbows Property") | Identifies if the leaders' elbows are merged or not. If they are are merged, all elbows are in the same point and they move together. |
| [MultiLeader](5501affb-b03f-8bca-de56-c12a42915bc6.md "MultiLeader Property") | Returns if the tag if referencing multiple elements and/or sub-elements. |
| [MultiReferenceAnnotationId](30363f1b-0fd1-fa0e-5617-be77d683662e.md "MultiReferenceAnnotationId Property") | The multi-reference annotation which owns this tag. |
...
| [RotationAngle](3b257113-5220-c9df-dd3c-50e1e28b847b.md "RotationAngle Property") | The rotation angle of the tag relative to its view |
| [TagHeadPosition](4f49d3f3-e5c5-108a-49dd-2a36697bd08e.md "TagHeadPosition Property") | The position of the head of tag in model coordinates. |
| [TagOrientation](d9d43a13-a972-3b69-2484-b6e336e9a0c5.md "TagOrientation Property") | The tag orientation of the tag's head, such as horizontal or vertical. |
| [TagText](8e297dee-920d-f620-6198-0bed494e3f04.md "TagText Property") | The text associated with the tag. If there are several strings assiciated with the tag, the strings will be returned concatenated. |
