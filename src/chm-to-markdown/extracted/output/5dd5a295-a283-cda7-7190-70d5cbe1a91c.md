# CreateNotContainsRule Method (ElementId, String, Boolean)
...
Revit 2024 API  
---  
ParameterFilterRuleFactory..::..CreateNotContainsRule Method (ElementId, String, Boolean)  
...
Public Shared Function CreateNotContainsRule ( _
...
[CreateNotContainsRule Overload](b378a694-1fd5-0a97-4763-c9b28afb611b.md "CreateNotContainsRule Method")
