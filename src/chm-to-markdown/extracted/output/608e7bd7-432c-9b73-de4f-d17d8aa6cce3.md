# BoundingBoxIntersectsFilter Constructor (Outline, Boolean)
...
inverted
    Type: System..::..Boolean True if the filter should be inverted and match all elements with a bounding box that are not intersecting the given Outline. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
