...
Revit 2024 API  
---  
MacroManager..::..GetDocumentMacroSecurityOptions Method   
...
---  
```text
public static DocumentMacroOptions GetDocumentMacroSecurityOptions(
...
---  
```text
Public Shared Function GetDocumentMacroSecurityOptions ( _
	application As Application _
) As DocumentMacroOptions
```
...
```text
public:
static DocumentMacroOptions GetDocumentMacroSecurityOptions(
	Application^ application
)
```
