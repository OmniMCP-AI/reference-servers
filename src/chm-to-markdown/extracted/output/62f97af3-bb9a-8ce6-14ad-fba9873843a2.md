...
---  
PipingSystem Members  
[PipingSystem Class](6abbdfa2-69a5-eef1-2663-89a5faf91831.md "PipingSystem Class") Methods Properties See Also  
---  
...
| [CanBeHydraulicLoopBoundary](4547afe6-e906-85f1-df6e-a7100eeae62f.md "CanBeHydraulicLoopBoundary Method") | Checks if the element can be used as a hydraulic loop boundary. |
...
| [Create(Document, ElementId)](130a3ca6-58fc-3548-bfe8-473e51fa736b.md "Create Method \(Document, ElementId\)") | Creates a new instance of a piping system and adds it to the document. |
| [Create(Document, ElementId, String)](bdfb862c-8547-1f6b-50fe-f28b40a50689.md "Create Method \(Document, ElementId, String\)") | Creates a new instance of a piping system and adds it to the document. |
| [CreateHydraulicSeparation](26d64a31-4fb6-cc54-af42-fc2bc1db479d.md "CreateHydraulicSeparation Method") | Creates new system which is hydraulically separated from the existing system. |
...
| [DeleteHydraulicSeparation](5524b379-b150-2181-3a33-d985ff2aa81f.md "DeleteHydraulicSeparation Method") | Deletes hydraulically separated systems and merges the system components into the connected system. |
...
| [GetFixtureUnits](ca222d0d-8eb9-2a9c-625b-3c243e0d9c29.md "GetFixtureUnits Method") | Gets the fixture units of this piping system. |
| [GetFlow](949e7120-6845-a62f-6156-b0504e243f84.md "GetFlow Method") | Gets the flow of this piping system. |
...
| [GetPumpSets](2a46ea1c-73e9-a258-4ad4-239a9011f7e9.md "GetPumpSets Method") | Gets the set of element Id's for all pump sets in the system, if any. |
...
| [GetStaticPressure](f50549b4-7aca-2766-36bb-aa6b53dfb5f5.md "GetStaticPressure Method") | Gets the static pressure of this piping system. |
...
| [GetVolume](2d77154e-9741-3cf9-d239-fae91b3735b4.md "GetVolume Method") | Gets the volume of this piping system. |
...
| [IsFlowServerMissing](bfdbd8f4-f15a-e58b-2bd0-473d75f9fa6c.md "IsFlowServerMissing Method") | Indicates if any flow server which was used in the piping system is not available. |
...
| [IsHydraulicLoopBoundary](7b33e27d-98c2-82de-2dd8-a2c4969e09e3.md "IsHydraulicLoopBoundary Method") | Checks if the element is a valid hydraulic loop boundary. |
...
| [IsPressureDropServerMissing](15b75922-cc13-8780-63a3-c024b89e6121.md "IsPressureDropServerMissing Method") | Indicates if any pressure drop server which was used in the piping system is not available. |
