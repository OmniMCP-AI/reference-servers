...
# Remarks
Depending on implementation for given element as the result, the element can be deleted - especially if after Subelement deletion there are no Subelement left. See also: [IsModifiable](65f9f835-daaa-3efa-2976-3f932aa18366.md "IsModifiable Property"). 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
