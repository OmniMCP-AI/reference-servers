...
---  
ElementType Members  
[ElementType Class](ffb18296-0448-559c-580c-7857cbcdc094.md "ElementType Class") Methods Properties See Also  
---  
The [ElementType](ffb18296-0448-559c-580c-7857cbcdc094.md "ElementType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Duplicate](b0e7d5d5-f33a-8ff2-b471-78a213f06ef5.md "Duplicate Method") | Duplicates an existing element type and assigns it a new name. |
...
| [GetPreviewImage](e79da134-713a-2202-4898-cca930202dff.md "GetPreviewImage Method") | Get the preview image of an element. This image is similar to what is seen in the Revit UI when selecting the type of an element. |
| [GetSimilarTypes](2719ca23-11c7-dda4-6291-9a4f0cebfb21.md "GetSimilarTypes Method") | Obtains a set of types that are similar to this type. |
...
| [IsSimilarType](bd1e5459-4909-dc8a-46fd-54540fe1961e.md "IsSimilarType Method") | Checks if given type is similar to this type. |
| [IsValidDefaultFamilyType](db029b02-e415-3807-d724-ec32b505d23a.md "IsValidDefaultFamilyType Method") | Identifies if this type is a valid default family type for the given family category id. |
...
| [CanBeCopied](588e4fac-5492-0e1d-c935-dfd53e801c04.md "CanBeCopied Property") | Determine if this ElementType can create a copy |
| [CanBeDeleted](5efe8253-d555-00c2-8db6-9114e328fcc7.md "CanBeDeleted Property") | Determine if this ElementType can be deleted |
| [CanBeRenamed](ce2e0f26-deaf-d649-0617-babde54c6bf7.md "CanBeRenamed Property") | Determine if this ElementType can be renamed |
...
| [FamilyName](10de5c66-1b4b-9214-4036-27a6b24e5703.md "FamilyName Property") | Gets the family name of this element type. |
...
| [Name](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.md "Name Property") | Set the name for the ElementType. (Overrides [Element..::..Name](e372092e-ff47-71c2-1272-50ab08e5a41d.md "Name Property").) |
