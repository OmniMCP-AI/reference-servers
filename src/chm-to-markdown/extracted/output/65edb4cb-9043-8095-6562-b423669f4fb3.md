...
---  
ComponentRepeater Members  
[ComponentRepeater Class](27dbc5bd-40e7-c044-11e6-7053adf92c6f.md "ComponentRepeater Class") Methods Properties See Also  
---  
The [ComponentRepeater](27dbc5bd-40e7-c044-11e6-7053adf92c6f.md "ComponentRepeater Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanElementBeRepeated](85030abd-7476-91fc-a67b-50dd8bcf9697.md "CanElementBeRepeated Method") | Determines whether an element can be repeated using the **RepeatElements** method. |
...
| [GetBasicIEnumerator](f88e21de-e2b8-571f-5ba3-5cf746506737.md "GetBasicIEnumerator Method") | Returns an enumerator that iterates through a collection. |
...
| [GetEnumerator](95071080-0ca2-ca24-76a2-5fd4ec2fb209.md "GetEnumerator Method") | Returns an enumerator that iterates through a collection. |
...
| [IsTypeValidForRepeater](64b2d4bf-7c8f-e641-5d78-e95565bc5c77.md "IsTypeValidForRepeater Method") | Determines whether given family type can be used as the default type for the repeater. |
...
| [RemoveRepeaters](f36b63f5-18dd-9279-7596-99548faf325e.md "RemoveRepeaters Method") | Removes component repeaters from the document, but leaves the individual repeated components in their respective locations and hosted on their original hosts. |
| [RepeatElements](fea4df07-ac92-08f3-ae93-8d0a512d0e76.md "RepeatElements Method") | Repeats a set of adaptive component hosted on one or more repeating references. |
...
| [DefaultFamilyType](5c58ac2c-7cf7-3fe1-dab4-7749c1b5a055.md "DefaultFamilyType Property") | The default family type for the component repeater. |
...
| [DimensionCount](c958b9ec-0aeb-d97f-0fcb-a0ecc58b9db6.md "DimensionCount Property") | The dimension count of the component repeater. |
