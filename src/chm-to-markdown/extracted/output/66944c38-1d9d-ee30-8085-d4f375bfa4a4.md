...
Revit 2024 API  
---  
StructuralConnectionHandler..::..Create Method (Document, IList<(Of <(<'ElementId>)>)>, ElementId, IList<(Of <(<'ConnectionInputPoint>)>)>)  
...
additionalInputPoints
    Type: System.Collections.Generic..::..IList<(Of <(<'[ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md "ConnectionInputPoint Class")>)>)> The array of points that help define the connection. 
# ### Return Value
