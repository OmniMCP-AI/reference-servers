...
Revit 2024 API  
---  
ExporterIFC..::..Set2DContextHandle Method   
...
---  
```text
Public Sub Set2DContextHandle ( _
...
# ### Parameters
contextHandle
    Type: [Autodesk.Revit.DB.IFC..::..IFCAnyHandle](8b893943-70fa-94bf-90be-1523d516ecb3.md "IFCAnyHandle Class") The IfcRepresentationContext. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
