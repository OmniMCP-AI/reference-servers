...
Revit 2024 API  
---  
FormatOptions..::..CanSuppressTrailingZeros Method (ForgeTypeId)  
...
---  
```text
Public Shared Function CanSuppressTrailingZeros ( _
...
[CanSuppressTrailingZeros Overload](55d9eef7-9cf3-3e2c-bdc2-f1e7eed04f73.md "CanSuppressTrailingZeros Method")
