...
---  
EnergyAnalysisSpace Members  
[EnergyAnalysisSpace Class](cd0567d0-f5e0-a850-6d10-bde911831947.md "EnergyAnalysisSpace Class") Methods Properties See Also  
---  
The [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md "EnergyAnalysisSpace Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetAnalyticalSurfaces](ed3a5d9b-8fbc-b17f-df57-6fc1033cb491.md "GetAnalyticalSurfaces Method") | Provides a way to access the collection of analytical surfaces for a space. Geometry data defining an analytical space volume. Through an analytical surface you can connect a source element with each polygon in a space. The analytical surfaces defines an enclosed volume bounded by the center plane of walls and the top plane of roofs and floors. |
| [GetBoundary](34f9d5ec-7195-0324-60a4-a2d51d8b2ab8.md "GetBoundary Method") | Gets the collection of polygons that form the 2D boundary. This method returns a collection of polyloops (planar polygons) that defines an enclosed area measured by interior bounding surfaces. |
| [GetClosedShell](58410893-1269-98e3-7a07-e5dacafbc9fe.md "GetClosedShell Method") | Gets the collection of polygons that form a closed shell. This method returns a collection of polyloops (planar polygons) that defines an enclosed volume measured by interior bounding surfaces. |
...
| --- | --- |
| --- | --- | --- |
| [Area](48a1a8b2-aba4-2c2b-a034-aa6ff514f70d.md "Area Property") | The area for this space. |
...
| [CADObjectUniqueId](9389805f-ff4c-078b-d79f-1736b0dc3f99.md "CADObjectUniqueId Property") | The unique id of the originating CAD object (model element) associated with this space. |
...
| [ComposedName](dc4bb53e-1f1a-ceeb-2875-4595296dce8a.md "ComposedName Property") | The composed name for this space. |
...
| [Description](393dee9c-00a3-17cd-174a-5fc659a16157.md "Description Property") | The description. |
...
| [Number](cff842c6-97e2-7728-c1a5-3fd25bddf1a6.md "Number Property") | The number to identify the space. |
...
| [SpaceName](e35fda64-158d-c86b-95e8-d2f212780443.md "SpaceName Property") | The name. |
...
| [Volume](36257f80-cd3d-c85d-8e9d-af6c298fee77.md "Volume Property") | The volume for this space. |
