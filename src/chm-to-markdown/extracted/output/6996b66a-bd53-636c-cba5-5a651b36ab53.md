...
---  
Form Members  
[Form Class](49f6ae4c-1629-98ef-d9a9-799bb1fd43ec.md "Form Class") Methods Properties See Also  
---  
...
| --- | --- |
| --- | --- | --- |
| [AreProfilesConstrained](2b231a7a-2cff-530d-4f7b-d51b2268362e.md "AreProfilesConstrained Property") | Get/set if the form's profiles are constrained. |
...
| [BaseOffset](d8bcb330-b182-4e67-ed96-2656afa5ee7b.md "BaseOffset Property") | Retrieve/set the base offset of the form object. It is only valid for locked form. |
...
| [CurveLoopReferencesOnProfile](89c48f40-ccec-5acd-f165-06b01004e80f.md "CurveLoopReferencesOnProfile Property") | The curve references in certain curve loop, specified by profile index and curve loop index. |
...
| [HasOneOrMoreReferenceProfiles](beb69916-074b-a484-0485-355b71f10582.md "HasOneOrMoreReferenceProfiles Property") | Tell if the form has any reference profile. |
| [HasOpenGeometry](08f123dc-a066-1635-cd12-41f060a6f0c5.md "HasOpenGeometry Property") | Tell if the form has an open geometry. |
...
| [IsInXRayMode](22f103aa-4091-87b6-aa69-6336d3b24bf7.md "IsInXRayMode Property") | Get/set if the form is in X-Ray mode. |
...
| [PathCurveCount](2469b633-67ff-6f8e-bb07-c427d968aba9.md "PathCurveCount Property") | The number of curves in the form path. |
| [PathCurveReference](433dd986-562d-c969-98c6-7a84f7f8090e.md "PathCurveReference Property") | The curve reference in the path, specified by curve index. |
...
| [ProfileCount](274746a9-4c77-3b3d-c814-a2f1384361f2.md "ProfileCount Property") | The number of profiles in the form. |
| [ProfileCurveLoopCount](5ba5320b-8200-5d21-e5b2-2e08cb72c709.md "ProfileCurveLoopCount Property") | The number of curve loops in certain profile, specified by profile index. |
...
| [TopOffset](338aee66-8550-80b2-7782-534b8c87a7e4.md "TopOffset Property") | Retrieve/set the top offset of the form object. It is only valid for locked form. |
