...
---  
MEPSystemType Members  
[MEPSystemType Class](9a14b7f0-1472-4375-c4f0-86f9f2479851.md "MEPSystemType Class") Methods Properties See Also  
---  
The [MEPSystemType](9a14b7f0-1472-4375-c4f0-86f9f2479851.md "MEPSystemType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| --- | --- |
| --- | --- | --- |
| [Abbreviation](6f21688c-b2b7-ad78-70a1-3f1de36eab18.md "Abbreviation Property") | Identifies the abbreviation, the short name, for the system type |
...
| [CalculationLevel](76631989-d84f-3954-8743-f42b58ba4f43.md "CalculationLevel Property") | Identifies the calculation level for the system type. |
...
| [FillColor](1b4309e7-bdf4-807a-a13a-6dcef6a94b50.md "FillColor Property") | Indicates the color that should override the fill color for all components in the system. |
| [FillPatternId](cc5413da-3984-5580-8303-70d790118cf3.md "FillPatternId Property") | Indicates the fill pattern id that should override the fill pattern id for all components in the system. |
| [FillVisible](a16ccaf8-461b-226f-c40a-4956c69b36f8.md "FillVisible Property") | Indicates the visibility of the fill pattern for all components in the system. |
...
| [LineColor](83e01a4d-d51e-42bf-fe18-7c5856fe5c6e.md "LineColor Property") | Indicates the color that should override the line color for all components in the system. |
| [LinePatternId](99830c67-ba7a-e28b-0d65-18b57c7f93af.md "LinePatternId Property") | Indicates the line pattern id that should override the line pattern id for all components in the system. |
| [LineWeight](605a0923-f8f1-7e76-d836-cd4cf427a5e2.md "LineWeight Property") | Indicates the weight that should override the line weight for all components in the system. |
...
| [MaterialId](8da78a66-2b7d-2231-a112-64cf1cee6c19.md "MaterialId Property") | Indicates the material id that should override the material for all components in the system. |
...
| [SystemClassification](be329290-0ca0-b6a6-85f8-d9e35be028f1.md "SystemClassification Property") | Identifies the classification for the system type |
