...
---  
ImageInstance Members  
[ImageInstance Class](ff77d6c8-a94a-067a-cd95-4f2cd3ec8dcc.md "ImageInstance Class") Methods Properties See Also  
---  
The [ImageInstance](ff77d6c8-a94a-067a-cd95-4f2cd3ec8dcc.md "ImageInstance Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](0f4cd250-7925-6714-3e08-2bd7c0266252.md "Create Method") | Creates a new ImageInstance element placed in a view. |
...
| [GetLocation](c275e3bf-00ab-2d2f-8c41-7d4cd7ff79fe.md "GetLocation Method") | Returns the location of one of the points of the ImageInstance |
...
| [IsValidView](ee7cd29b-d142-27e8-4fc0-4eff2109b1c1.md "IsValidView Method") | Check that the view is a valid view for ImageInstance elements |
...
| [SetLocation](2ca53d23-6e03-838c-b755-2478f778357d.md "SetLocation Method") | Moves the ImageInstance to the specified location |
...
| [CanHaveSnaps](ac6a3521-50ad-3573-11b1-d29038730dae.md "CanHaveSnaps Property") | When true the ImageInstance has snaps that can be enabled with the [EnableSnaps](73df0a9a-d0d6-33fe-0fd9-ce2c1f77255e.md "EnableSnaps Property") property |
...
| [DrawLayer](81510a8d-d74e-bf19-dd79-f8909b178d20.md "DrawLayer Property") | The layer the ImageInstance will be drawn in. |
| [EnableSnaps](73df0a9a-d0d6-33fe-0fd9-ce2c1f77255e.md "EnableSnaps Property") | When true the ImageInstance will have its snaps enabled, but only if [CanHaveSnaps](ac6a3521-50ad-3573-11b1-d29038730dae.md "CanHaveSnaps Property") is true |
...
| [Height](ba996fed-0624-689f-08a8-1488cdb1292a.md "Height Property") | The height of the ImageInstance. |
| [HeightScale](c0c41a38-7554-4472-479a-794b561a6534.md "HeightScale Property") | The factor applied to the [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.md "ImageType Class") to calculate the [Height](ba996fed-0624-689f-08a8-1488cdb1292a.md "Height Property") of the ImageInstance. |
...
| [LockProportions](2eda8038-9240-00f5-ffa3-a65d8b4df5f2.md "LockProportions Property") | When true the proportion of [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.md "Width Property") to [Height](ba996fed-0624-689f-08a8-1488cdb1292a.md "Height Property") will be maintained |
...
| [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.md "Width Property") | The width of the ImageInstance. |
| [WidthScale](c938de3b-849b-11a0-c80b-cb852b65c64b.md "WidthScale Property") | The factor applied to the width of the [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.md "ImageType Class") to calculate the [Width](c135b323-bdcf-4945-6f7b-f2da08bb41fe.md "Width Property") of the ImageInstance. |
