# WallSweepInconsistent Property
...
---  
```text
public static FailureDefinitionId WallSweepInconsistent { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property WallSweepInconsistent As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ WallSweepInconsistent {
