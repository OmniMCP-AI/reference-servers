...
---  
```text
public static FailureDefinitionId NotBentMaskingRegion { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property NotBentMaskingRegion As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ NotBentMaskingRegion {
