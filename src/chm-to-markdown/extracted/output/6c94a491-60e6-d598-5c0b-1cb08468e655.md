...
---  
Viewport Members  
[Viewport Class](5991dc40-234a-4835-cc06-07524d2e61a4.md "Viewport Class") Methods Properties See Also  
---  
The [Viewport](5991dc40-234a-4835-cc06-07524d2e61a4.md "Viewport Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanAddViewToSheet](1da33e38-255f-a27a-0626-9891d897b29a.md "CanAddViewToSheet Method") | Verifies that the view can be added to the ViewSheet. |
...
| [Create](0f951f28-eb6b-2a37-668a-b248bfb7de97.md "Create Method") | Creates a new Viewport at a given location on a sheet. |
...
| [GetBoxCenter](10a5ede6-0c97-79e0-a31a-2ffd90c7fc97.md "GetBoxCenter Method") | Returns the center of the outline of the viewport on the sheet, excluding the viewport label. |
| [GetBoxOutline](034750ce-be6c-456b-7f3f-ee0ab5b5e2c0.md "GetBoxOutline Method") | Returns the outline of the viewport on the sheet, excluding the viewport label. |
...
| [GetLabelOutline](dcc1b956-d611-2554-a040-da9ed1633c06.md "GetLabelOutline Method") | Gets the outline viewport's label on the sheet. |
...
| [GetProjectionToSheetTransform](3c55684a-b4fd-851e-3b32-6a3eb1e9eb3b.md "GetProjectionToSheetTransform Method") | Returns the transform from the view's projection space to the sheet space. |
...
| [HasViewportTransforms](474169c5-2e94-ed0b-95e2-851d96dd3723.md "HasViewportTransforms Method") | Indicates if the viewport has transforms. |
...
| [IsViewIdValidForViewport](9ab7aa51-8dce-bdda-10e5-7d2d3dfd09b2.md "IsViewIdValidForViewport Method") | Verifies that the Viewport can change it's view id to the input %viewId%. |
...
| [SetBoxCenter](71734b96-6582-e6c5-674a-e6c092ced0f2.md "SetBoxCenter Method") | Moves this viewport so that the center of the box outline (excluding the viewport label) is at a given point. |
...
| [LabelLineLength](1b9cdb90-85ba-424a-3df0-33cab7d066f6.md "LabelLineLength Property") | The length of the viewport label line in sheet space, measured in feet. |
| [LabelOffset](d2856541-4f08-f212-99b3-0eee98bdb43c.md "LabelOffset Property") | The offset is a two-dimensional vector from left bottom corner of the viewport with Rotation set to None to the left end of the viewport label line. The Z coordinate is ignored. |
...
| [Rotation](abd81744-b44a-e578-cb62-3cc40a334acc.md "Rotation Property") | The rotation of the viewport on the sheet. |
| [SheetId](187ece0f-f732-ec3c-1f20-ad688b8c1499.md "SheetId Property") | The element id of the ViewSheet on which the viewport appears, or InvalidElementId if this viewport does not associate a view with placement onto a sheet. |
...
| [ViewId](f96f5255-17b5-d4fc-c3a3-049fae1f6eb9.md "ViewId Property") | The element id of the associated View. |
| [ViewportPositioning](f82b1639-99e0-6951-28d2-ece6c5b6bc25.md "ViewportPositioning Property") | Specifies the method the viewport will be positioned on the sheet when swapped to another view. Default is set to ViewportPositioning::ViewportCenter. |
