# BuiltInFailures.MEPFabricationFailures Members
...
---  
BuiltInFailures..::..MEPFabricationFailures Members  
[BuiltInFailures..::..MEPFabricationFailures Class](e35f48ff-3e49-a71c-fb61-f7f9fa6c4382.md "BuiltInFailures.MEPFabricationFailures Class") Properties See Also  
---  
Provides a container of all Revit built-in FailureDefinitionId instances.
The [BuiltInFailures..::..MEPFabricationFailures](e35f48ff-3e49-a71c-fb61-f7f9fa6c4382.md "BuiltInFailures.MEPFabricationFailures Class") type exposes the following members.
# Properties
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AdditionalPartNotLoaded](17baf655-2197-a356-b5e9-8bed3fd5fb11.md "AdditionalPartNotLoaded Property") | An additional part was not loaded. |
| [CannotConvertFlexPipeToPart](c84eb0ba-ca83-2cb1-a5af-91ad7954789c.md "CannotConvertFlexPipeToPart Property") | Cannot convert flex pipe to fabrication part. |
| [CannotMatchFabricationHangerSizeToHost](2df28deb-a2a2-1259-5d07-1bafa71cc08e.md "CannotMatchFabricationHangerSizeToHost Property") | The hanger cannot be re-sized to match the re-sized host. |
| [FabDbChangeConn](587e7425-4d77-bd37-96c9-a43e977ed6f0.md "FabDbChangeConn Property") | Fabrication Database changes altered connectivity |
| [FabDbOpenJobConn](29272303-5485-e3e1-d794-3a6f26f6fde8.md "FabDbOpenJobConn Property") | Fabrication job imported had bad connectivity |
| [FabDbSwapOut](bff282fd-c9bd-3bbe-5f97-1ea02490294f.md "FabDbSwapOut Property") | Fabrication Database reload could not swap out for newer parts. |
| [FabricationConfigurationCorrupted](8380505d-1508-3a07-a713-acf81d5e4acd.md "FabricationConfigurationCorrupted Property") | It looks that the Fabrication Configuration %1!s! was corrupted, please check it at %2!s!. |
| [FabricationHangerCannotBeSloped](0366bd7b-f2dd-412c-c467-320484fb0d1b.md "FabricationHangerCannotBeSloped Property") | A hanger cannot be sloped or placed on a sloped element. |
| [FabricationHangerHostNotFound](a45ca5d7-ace1-6b12-806c-2e00f62886d9.md "FabricationHangerHostNotFound Property") | The hanger will disconnect because we can't find the suitable host. |
| [FabricationHangerNotConnectToHost](001f5115-a02a-8973-ca1f-a78a12185ea7.md "FabricationHangerNotConnectToHost Property") | Fabrication Hanger didn't connect to the %s host. |
| [FabricationHangerOutOfHost](51527e2f-6e87-9682-3156-154f5e8644c4.md "FabricationHangerOutOfHost Property") | The hanger is out of its host and will be disconnected. |
| [FabricationHangerSizeNotMatch](3b143519-2fe3-f1e8-f889-77a9d36a1540.md "FabricationHangerSizeNotMatch Property") | The hanger size does not match the size of the host, so it can not be connected. |
| [FabricationOutOfSizeCondition](85ef6496-b0a7-a54f-407b-2fc243485f8c.md "FabricationOutOfSizeCondition Property") | The fabrication part size is not within the correct size range for the service button condition. |
| [FabricationOverSizedCheck](3067d96d-7595-2952-88ef-b08de16f85aa.md "FabricationOverSizedCheck Property") | Fabrication part is too large to fit on the sheet metal. Replace the part with multiple smaller parts, or notify the CAM operator. |
| [FabricationPartCannotBeMirrored](768aefbf-073d-4c8d-7098-970760a83ae0.md "FabricationPartCannotBeMirrored Property") |
| [FabricationPartCannotChangeServiceSizeWarning](85244bb3-6e6c-c7c9-b52e-bf57ccd8a8af.md "FabricationPartCannotChangeServiceSizeWarning Property") | The selected fitting(s) cannot successfully change service or change size. You must disconnect the connections on the fitting(s) and try again. |
| [FabricationPartCannotChangeSlopeError](f3dc0e0f-5926-6bfb-6c2d-0a8596dd3112.md "FabricationPartCannotChangeSlopeError Property") | The connected fitting(s) cannot successfully change to the new slope value. You may try to disconnect the connections on the fitting(s) and try again. |
| [FabricationPartCannotChangeTypeBadDimError](80be01c2-73e0-c7d1-6265-46fb900c90cb.md "FabricationPartCannotChangeTypeBadDimError Property") | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part may have badly configured dimensions or be constrained due to connected fitting(s). You may try to disconnect the connections on the fitting(s) and try again. |
| [FabricationPartCannotChangeTypeBadDimUnConnError](6befc086-4872-4100-2061-9adb02a8d226.md "FabricationPartCannotChangeTypeBadDimUnConnError Property") | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part may have badly configured dimensions, resulting in bad geometry. |
| [FabricationPartCannotChangeTypeError](5d819cec-31a8-119d-c8a1-ca5e7d7c4a17.md "FabricationPartCannotChangeTypeError Property") | The selected fitting(s) cannot successfully change the type. You must disconnect the connections on the fitting(s) and try again. |
| [FabricationPartCannotChangeTypeIncompatError](065a0de4-c1a5-5745-54e7-923b75a2ddaf.md "FabricationPartCannotChangeTypeIncompatError Property") | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part type either has no material or has badly configured dimensions, resulting in bad geometry. You may try to disconnect the connections on the fitting(s) and try again. |
| [FabricationPartCannotChangeTypeIncompatUnConnError](d2d38abc-e75f-9031-7cdf-5a98f9747ed3.md "FabricationPartCannotChangeTypeIncompatUnConnError Property") | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part type either has no material or has badly configured dimensions, resulting in bad geometry. |
| [FabricationPartCannotChangeTypeMisalignedError](ef3c9cce-c8d0-a307-87c0-a83b3a6b81d4.md "FabricationPartCannotChangeTypeMisalignedError Property") | The selected fitting(s) cannot successfully change the type. The newly selected fabrication part type has a problem with the angle dimension of the current fitting(s), resulting in bad geometry. You may try to disconnect the connections on the fitting(s) and try again. |
