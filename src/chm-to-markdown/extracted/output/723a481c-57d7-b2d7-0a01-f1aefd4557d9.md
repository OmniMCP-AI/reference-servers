...
---  
LoadBase Members  
[LoadBase Class](4130f6dc-1963-2105-d85b-e08a7c34af8b.md "LoadBase Class") Methods Properties See Also  
---  
The [LoadBase](4130f6dc-1963-2105-d85b-e08a7c34af8b.md "LoadBase Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [IsOrientToPermitted](8681b54f-c427-9024-9ede-98ec917d0f8d.md "IsOrientToPermitted Method") | Indicates if the provided orientation is permitted for this load. |
...
| [RemoveHostConstraint](f94ac73c-c975-70e5-f905-966439f5163a.md "RemoveHostConstraint Method") | Removes constraint from host for this load. |
...
| [HostElementId](c0fc581d-431e-0749-e7d9-7218e9b426c8.md "HostElementId Property") | The host element ID for the load. |
...
| [IsConstrainedOnHost](355eed18-c9de-4a00-29fa-82ca04462a6a.md "IsConstrainedOnHost Property") | The load is constrained to host or not. |
| [IsHosted](76965c6d-473a-9ad9-8a72-baa7a47b055a.md "IsHosted Property") | Indicates if the Load is hosted or non-hosted. |
...
| [IsReaction](3d159400-28fb-9f92-b4b1-1aab870c21f0.md "IsReaction Property") | The load is reaction option. |
...
| [LoadCase](f0d56d0d-dc16-1fb2-f27f-70a989f6bbcf.md "LoadCase Property") | The load case for the load. |
| [LoadCaseId](8bb0908c-30a7-f090-7586-b1bab8e8cc42.md "LoadCaseId Property") | The load case ID for the load. |
| [LoadCaseName](9bf650db-2f9c-08c3-ad05-33ce349b9134.md "LoadCaseName Property") | The name of the load case to which this load belongs. |
| [LoadCategoryName](4a1c7865-8f07-b291-6cc8-fb23a842dad8.md "LoadCategoryName Property") | The name of the category to which this load belongs. |
| [LoadNatureName](3f764b90-19b0-8fbb-50ae-f38400a89676.md "LoadNatureName Property") | A string representing the nature of the load. |
...
| [OrientTo](c1252918-899f-23f0-c3e8-c0e5817ef812.md "OrientTo Property") | The load orientation option. |
...
| [WorkPlaneId](19d3d2d4-82e9-465a-5cf4-d3e613ad238f.md "WorkPlaneId Property") | Id of the work plane which may determine the orientation of the load. |
