...
---  
RebarInSystem Members  
[RebarInSystem Class](c0bd03fa-78f4-eb67-54e8-e28368e94beb.md "RebarInSystem Class") Methods Properties See Also  
---  
...
| --- | --- |
| --- | --- | --- |
| [ArrayLength](4c7280d4-3cad-d5bd-44db-c55ada9c03e4.md "ArrayLength Property") | Identifies the distribution path length of rebar set. |
...
| [BarsOnNormalSide](65453ee2-9437-9dd1-893e-2c2c576eb581.md "BarsOnNormalSide Property") | Identifies if the bars of the rebar set are on the same side of the rebar plane indicated by the normal. For the current implementation of RebarInSystem, this property will always return true, but it is included in the RebarInSystem interface for consistency with the Rebar class. |
...
| [LayoutRule](bff8d973-7a55-e9c4-dab5-ff15c3242ec4.md "LayoutRule Property") | Identifies the layout rule of rebar set. |
...
| [MaxSpacing](bc74c939-d06d-b245-c0a5-73c2452f3817.md "MaxSpacing Property") | Identifies the maximum spacing between rebar in rebar set. |
...
| [Normal](d3a3c025-f441-046a-5879-7023f019c2c1.md "Normal Property") | A unit-length vector normal to the plane of the rebar |
| [NumberOfBarPositions](2c21e5cd-9d10-c9a7-3d5f-68327a04b7b9.md "NumberOfBarPositions Property") | The number of bar positions available in the rebar. |
...
| [Quantity](e8c55ade-5864-a1ec-4354-930f475f2414.md "Quantity Property") | Identifies the number of bars in rebar set. |
| [RebarShapeId](c1687ed1-98dd-2c0f-ec09-09e8e79b929d.md "RebarShapeId Property") | The RebarShape element that defines the shape of the rebar. |
| [ScheduleMark](678c6f55-4d6c-ac21-069a-1f8de09f7bd4.md "ScheduleMark Property") | The Schedule Mark parameter. On creation, the Schedule Mark is set to a value that is unique to the host, but it can be set to any value. |
| [SystemId](17943658-b26e-f781-0aee-df60b5e8cfbe.md "SystemId Property") | The Id of an AreaReinforcement or PathReinforcement element that owns this element. |
| [TotalLength](d1034aa8-b0d4-cabc-54ff-44fbb899e43c.md "TotalLength Property") | The length of an individual bar multiplied by Quantity. |
...
| [Volume](5c4367bd-eb48-b634-2b9a-bfaba9c3a5ca.md "Volume Property") | The volume of an individual bar multiplied by Quantity. |
