...
---  
Inserts multiple [VertexStreamPositionNormal](fc9b191e-cbd9-844c-0289-b58ccc19ac8b.md "VertexStreamPositionNormal Class") instances into the stream and associated buffer. 
...
Public Sub AddVertices ( _
	vertices As IList(Of VertexPositionNormal) _
)
```
...
# ### Parameters
vertices
    Type: System.Collections.Generic..::..IList<(Of <(<'[VertexPositionNormal](a40efda7-6e2f-a455-f65e-02b10b0bc1b4.md "VertexPositionNormal Class")>)>)> The vertices to be inserted. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
