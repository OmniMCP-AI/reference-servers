# StructuralConnectionHandlerType Members
...
---  
StructuralConnectionHandlerType Members  
[StructuralConnectionHandlerType Class](e948a909-1b00-8789-6302-b46015c9cb47.md "StructuralConnectionHandlerType Class") Methods Properties See Also  
---  
The [StructuralConnectionHandlerType](e948a909-1b00-8789-6302-b46015c9cb47.md "StructuralConnectionHandlerType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddElementsToCustomConnection](4ce5c475-c74a-c5aa-0724-8df7c1a0cacb.md "AddElementsToCustomConnection Method") | Modifies StructuralConnectionHandlerType of input StructuralConnectionHandler by adding representors of input elements or subelements. |
...
| [CreateDefaultStructuralConnectionHandlerType](3334270c-e2eb-855c-b8d6-4a7f0388ebe8.md "CreateDefaultStructuralConnectionHandlerType Method") | Creates a new StructuralConnectionHandlerType object with a default name. |
...
| [FindGenericConnectionType](83298a62-78c9-8182-f742-a4aeff747bec.md "FindGenericConnectionType Method") | Finds StructuralConnectionHandlerType which is Generic Connection type. |
| [GetDefaultConnectionHandlerType](f9b606a4-2656-dca7-8f8e-469630bd151e.md "GetDefaultConnectionHandlerType Method") | Gets a default type id for Structural Connection. |
...
| [IsCustom](ecd5d004-964f-eb6a-c4b2-0916fd8e0b93.md "IsCustom Method") | Checks if StructuralConnectionHandlerType is custom. |
...
| [IsDetailed](0a36101d-7ce2-c7b5-7e94-ae2b824d10c4.md "IsDetailed Method") | Checks if StructuralConnectionHandlerType is detailed. |
...
| [IsGeneric](697a72c2-a01f-4203-db5c-c3c95d44261e.md "IsGeneric Method") | Checks if StructuralConnectionHandlerType is generic. |
...
| [IsTypeNameValidForCustomConnection](1b1a9194-d048-7d41-eb53-94b9201e2a9b.md "IsTypeNameValidForCustomConnection Method") | Validates if the input name matches the criteria of StructuralConnectionHandlerType name. Name must be unique among other existing StructuralConnectionHandlerTypes and cannot contain any of the following characters: new line, {}[];`~\\\/:*?";<> | or any of the non-printable characters. |
...
| [RemoveMainSubelementsFromCustomConnection](09882898-b699-9b91-742b-ea6bd75942a1.md "RemoveMainSubelementsFromCustomConnection Method") | Removes one or more subelements from a StructuralConnectionHandlerType. The subelements will be erased. |
...
| [ConnectionGuid](625f6a3a-b0af-0d21-1f20-0af3609049bd.md "ConnectionGuid Property") | The GUID to use for identifying connection geometry generation algorithm. |
