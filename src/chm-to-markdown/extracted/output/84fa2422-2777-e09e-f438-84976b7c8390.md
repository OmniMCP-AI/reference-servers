...
---  
ColorFillScheme Members  
[ColorFillScheme Class](c405eb5b-14fa-0fea-a750-dcd9925a90b0.md "ColorFillScheme Class") Methods Properties See Also  
---  
...
| --- | --- |
| --- | --- | --- |
| [AddEntry](8c7f6d04-66ab-19ef-d00c-445aa4570f82.md "AddEntry Method") | Adds new entry to the scheme. |
| [AreEntriesConsistentWithScheme](a368c926-4d60-0fde-4e21-0a7c815db691.md "AreEntriesConsistentWithScheme Method") | Checks whether the entries can be set to the scheme or not. |
...
| [CanDefineByRange](f4592c9f-40f1-703c-21e7-17bb7c2f3747.md "CanDefineByRange Method") | Checks whether the scheme entries can be explained by range. |
...
| [CanRemoveEntry](d19264f1-e9f1-462f-f2c3-7f4ae9f2c9d0.md "CanRemoveEntry Method") | Checks whether entry can be removed from the scheme. |
| [CanUpdateEntry](f7f0bdd9-8076-69f1-bf81-776c40f42a22.md "CanUpdateEntry Method") | Checks whether entry exists in the scheme and not the same as input one. |
...
| [Duplicate](095596ae-d215-bf22-ccfa-fae85109d1a0.md "Duplicate Method") | Generates a copy of current scheme. |
...
| [GetEntries](bb3b650c-2718-28b7-c4bb-be3f80fb3e32.md "GetEntries Method") | Retrieves copies of all entries. |
...
| [GetFormatOptions](74e725cd-a74e-5ac6-d01e-0d1022208eb1.md "GetFormatOptions Method") | Returns the FormatOptions of the scheme. |
...
| [GetSupportedParameterIds](d19ac539-c56d-1c3c-1b7b-8801e9713c06.md "GetSupportedParameterIds Method") | Retrieves collection of all parameters supported by the scheme. |
...
| [IsEntryConsistentWithScheme](887cb0a0-2ad3-9a2c-8f46-c86e404539f8.md "IsEntryConsistentWithScheme Method") | Checks whether an entry can be added to the scheme or not. |
...
| [IsValidParameterDefinitionId](df43fe3e-0b93-ef67-c877-eedbaf6a7f49.md "IsValidParameterDefinitionId Method") | Checks whether the input parameter id can be applied to the scheme. |
| [IsValidSchemeName](ecae1c30-8417-dae7-8364-30f75145bb06.md "IsValidSchemeName Method") | Checks whether the name is valid for new generated scheme. |
...
| [RemoveEntry](e7441d50-0e17-21be-8ff6-aadadacad417.md "RemoveEntry Method") | Removes an entry whose parameter value is the same as the input from the scheme |
...
| [SetEntries](a2099010-ccb3-5ad1-5e80-5209422add42.md "SetEntries Method") | Update scheme entries in batch mode. |
| [SetFormatOptions](6558114a-4587-ff68-17a9-e58f0dfea0bb.md "SetFormatOptions Method") | Sets the FormatOptions of the scheme. |
| [SortEntries](b1cec6a3-6b60-b47f-2ea6-a6d7df9555c0.md "SortEntries Method") | Sorts the scheme entries ascending. |
| ToString | Returns a string that represents the current object. (Inherited from Object.) |
| [UpdateEntry](47fece43-de9a-e343-62be-e6907c584933.md "UpdateEntry Method") | Updates the scheme entry with the same parameter value as the input entry. |
