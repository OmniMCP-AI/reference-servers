# StructuralSectionIParallelFlange Members
...
---  
StructuralSectionIParallelFlange Members  
[StructuralSectionIParallelFlange Class](25683f55-98e6-852b-a7f2-85d1a9c2fede.md "StructuralSectionIParallelFlange Class") Constructors Methods Properties See Also  
---  
The [StructuralSectionIParallelFlange](25683f55-98e6-852b-a7f2-85d1a9c2fede.md "StructuralSectionIParallelFlange Class") type exposes the following members.
# Constructors
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [StructuralSectionIParallelFlange](e1a731a9-ea32-bef5-18b4-a92d89d085e7.md "StructuralSectionIParallelFlange Constructor") | Creates a new instance of Structural Section I Parallel Flange shape with the associated set of parameters, used to attach to structural element. |
...
| [GetFlangeThicknessInFlangeCenter](46f6b1ef-44f4-d429-fd63-b5a98db15f2f.md "GetFlangeThicknessInFlangeCenter Method") | Returns thickness of flange measured in the 0.25 * (width - webThickess), sometimes used for sections with width > 300 mm.  (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md "StructuralSectionGeneralI Class").) |
| [GetFlangeThicknessInQuarterWidth](9319279c-d6dc-72f5-fa4d-2e9b1b4feb10.md "GetFlangeThicknessInQuarterWidth Method") | Returns thickness of flange measured in the 0.25 * width, sometimes used for sections with width <= 300 mm.  (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md "StructuralSectionGeneralI Class").) |
...
| [BoltDiameter](1030bec7-f126-7b70-e428-39a3e350b7d0.md "BoltDiameter Property") | Maximum bolt hole diameter, in. (mm) |
| [BoltSpacing](4b316e2f-ef19-49b0-32da-0a99c8d2e627.md "BoltSpacing Property") | Standard bolt spacing, in. (mm) |
...
| [ClearWebHeight](a3ecb2bb-18df-2162-152b-2e6834e6a68d.md "ClearWebHeight Property") | Detailing depth between the web toes of the fillets, in.(mm) |
...
| [FlangeFillet](dcbf6a27-cdd3-0cd6-5d62-816919635667.md "FlangeFillet Property") | Flange Fillet - fillet radius at the flange end.  (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md "StructuralSectionGeneralI Class").) |
...
| [FlangeToeOfFillet](2cbc82c1-fa59-26b6-ed48-c26d7f607989.md "FlangeToeOfFillet Property") | Detailing distance from center of web to flange toe of fillet, in. (mm)  (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md "StructuralSectionGeneralI Class").) |
...
| [SlopedFlangeAngle](a6ca0625-e72e-5964-3368-269b51e938c3.md "SlopedFlangeAngle Property") | Sloped flange angle. (rad)  (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md "StructuralSectionGeneralI Class").) |
...
| [WebToeOfFillet](cda6d038-dcae-fa11-7f5e-288d8424da3b.md "WebToeOfFillet Property") | Detailing distance from outer face of flange to web toe of fillet, in. (mm)  (Inherited from [StructuralSectionGeneralI](28751ea7-5d5a-01a9-06a9-d895589bad07.md "StructuralSectionGeneralI Class").) |
...
# See Also
[StructuralSectionIParallelFlange Class](25683f55-98e6-852b-a7f2-85d1a9c2fede.md "StructuralSectionIParallelFlange Class")
