...
Revit 2024 API  
---  
ScheduleDefinition..::..RemoveField Method (ScheduleFieldId)  
...
# ### Parameters
fieldId
    Type: [Autodesk.Revit.DB..::..ScheduleFieldId](e437cc01-b976-fe8a-225a-1a0024171fae.md "ScheduleFieldId Class") The ID of the field to remove. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
