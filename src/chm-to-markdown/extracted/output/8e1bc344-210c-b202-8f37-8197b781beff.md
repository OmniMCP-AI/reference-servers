# Import Method (String, DGNImportOptions, View, ElementId)
...
Revit 2024 API  
---  
Document..::..Import Method (String, DGNImportOptions, View, ElementId%)  
...
# ### Parameters
file
    Type: System..::..String Full path of the file to import. File must exist and must be a valid DGN file. 
options
    Type: [Autodesk.Revit.DB..::..DGNImportOptions](81dec13f-8eca-f2eb-bf60-1e206e6d0d98.md "DGNImportOptions Class") Various options applicable to the DGN format. If nullNothingnullptra null reference (Nothing in Visual Basic), all options will be set to their respective default values. 
pDBView
...
elementId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class")% The id of imported instance after a successful import. 
# ### Return Value
