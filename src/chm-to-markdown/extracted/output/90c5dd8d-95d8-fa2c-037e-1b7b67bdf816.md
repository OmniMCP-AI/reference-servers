# WorksharingDisplaySettings Members
...
---  
WorksharingDisplaySettings Members  
[WorksharingDisplaySettings Class](ec25e291-6582-7e8c-f273-efc0c391bcc4.md "WorksharingDisplaySettings Class") Methods Properties See Also  
---  
The [WorksharingDisplaySettings](ec25e291-6582-7e8c-f273-efc0c391bcc4.md "WorksharingDisplaySettings Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanUserHaveOverrides](e50869c9-ce9d-6dad-44cf-e4d929b2196b.md "CanUserHaveOverrides Method") | Checks whether a single username can have customized graphic overrides. |
...
| [GetAllUsersWithGraphicOverrides](4df2c37c-fca2-80a3-980d-50a478220c58.md "GetAllUsersWithGraphicOverrides Method") | Returns all usernames that have graphic overrides. This list consists of all users included in the user table + all users who have explicitly been assigned overrides. |
...
| [GetOrCreateWorksharingDisplaySettings](32871a69-64cd-adcb-7fd9-ae9a60f3615a.md "GetOrCreateWorksharingDisplaySettings Method") | Returns the worksharing display settings for the document, creating new settings for the current user if necessary. |
...
| [GetRemovedUsers](1a79abbd-a072-2e11-1405-06252915fd9e.md "GetRemovedUsers Method") | Returns the set of users who have been explicitly removed from the settings. |
...
| [RemoveUsers](d714db4a-2b0e-e8da-2002-3508a3d71772.md "RemoveUsers Method") | Removes users from the list of displayed users and permanently discards any customization of the graphics. Note that a user cannot be removed if he or she owns any elements. |
| [RestoreUsers](da4f0c9e-3c5d-1869-3351-5c93d815fe7a.md "RestoreUsers Method") | Adds users back to the list of displayed users and permits customization of the graphics. Any usernames that are not currently removed will be ignored. Returns the number of users who were actually restored. |
...
| [UserHasGraphicOverrides](84a5e6ac-480e-cc1e-936c-912f22080c1d.md "UserHasGraphicOverrides Method") | Checks whether there are graphic overrides that would apply to elements owned by the given user in the "Individual Owners" display mode. |
