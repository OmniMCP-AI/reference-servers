...
---  
PathReinforcement Members  
[PathReinforcement Class](1593a849-b883-73d4-7c02-a2522877d71d.md "PathReinforcement Class") Methods Properties See Also  
---  
The [PathReinforcement](1593a849-b883-73d4-7c02-a2522877d71d.md "PathReinforcement Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [ConvertRebarInSystemToRebars](860c0773-13e2-00be-eeb8-25afa57fe2be.md "ConvertRebarInSystemToRebars Method") | Converts all RebarInSystem elements owned by the input PathReinforcement to equivalent Rebar elements. |
...
| [GetCurveElementIds](6a17f4fa-5d3a-2e3b-ce1c-fefa0dd941dd.md "GetCurveElementIds Method") | Retrieves the set of ElementIds of curves forming the boundary of the Path Reinforcement. |
...
| [GetHostId](61909903-e670-132a-cd41-07f85ff6302b.md "GetHostId Method") | The element that contains the Path Reinforcement. |
...
| [GetOrCreateDefaultRebarShape](4db777aa-4687-e1c1-3104-0fa1c8d9e576.md "GetOrCreateDefaultRebarShape Method") | Creates a new RebarShape object with a default name or returns existing one which fulfills Path Reinforcement bending data requirements. |
...
| [GetRebarInSystemIds](66d7ac46-c022-c65a-0c18-4fdedb77c5f6.md "GetRebarInSystemIds Method") | Returns the ids of the RebarInSystem elements owned by the PathReinforcement element. |
...
| [IsAlternatingLayerEnabled](2f3af8f8-18c1-8b9f-2ed4-2d049260af86.md "IsAlternatingLayerEnabled Method") | Checks if alternating bars are present in Path Reinforcement. |
...
| [IsUnobscuredInView](051a0fc5-cd26-7756-1331-d532639d5ac3.md "IsUnobscuredInView Method") | Checks if Path Reinforcement is shown unobscured in a view. |
| [IsValidAlternatingBarOrientation](8bf22e76-2e49-688a-0701-fafddc316572.md "IsValidAlternatingBarOrientation Method") | Checks if orientation for alternating bars is valid. |
| [IsValidPrimaryBarOrientation](96ef910c-7689-9aaa-3637-50826bce3f54.md "IsValidPrimaryBarOrientation Method") | Checks if orientation for primary bars is valid. |
| [IsValidRebarShapeId](0d570de9-c041-3bf2-dff7-47720ee6ace7.md "IsValidRebarShapeId Method") | Identifies whether an element id corresponds to a Rebar Shape element which can be used in Path Reinforcement. |
...
| [RemovePathReinforcementSystem](f363e5b7-056b-4fa2-7b0f-388614effd85.md "RemovePathReinforcementSystem Method") | Deletes the specified PathReinforcement, and converts its RebarInSystem elements to equivalent Rebar elements. |
...
| [SetUnobscuredInView](5533aeb2-dc1f-a329-165e-2107272a0fc3.md "SetUnobscuredInView Method") | Sets Path Reinforcement to be shown unobscured in a view. |
...
| --- | --- |
| --- | --- | --- |
| [AdditionalOffset](07b9ba68-2a6f-8948-a61e-4364be70902c.md "AdditionalOffset Property") | Additional offset of rebars in the Path Reinforcement. |
| [AlternatingBarOrientation](eaffd4ed-4eb5-ddc9-c174-07ecaca807c2.md "AlternatingBarOrientation Property") | Orientation of alternating bars of Path Reinforcement. |
| [AlternatingBarShapeId](192a6b79-2b79-b4f3-a084-8dd0940d9e42.md "AlternatingBarShapeId Property") | The RebarShape element that defines the shape of the alternating bars of the Path Reinforcement. |
...
| [PathReinforcementType](01592a23-de13-fd3e-7508-55e1d83994d1.md "PathReinforcementType Property") | Retrieves the type of the Path Reinforcement. |
...
| [PrimaryBarOrientation](a351b2f4-2f3e-e0e4-7bb1-0fab85004fdc.md "PrimaryBarOrientation Property") | Orientation of primary bars of Path Reinforcement. |
| [PrimaryBarShapeId](06e0653f-9e58-c180-67b3-cbdd74f2d345.md "PrimaryBarShapeId Property") | The RebarShape element that defines the shape of the primary bars of the Path Reinforcement. |
