# CreateEndsWithRule Method (ElementId, String, Boolean)
...
Revit 2024 API  
---  
ParameterFilterRuleFactory..::..CreateEndsWithRule Method (ElementId, String, Boolean)  
...
Public Shared Function CreateEndsWithRule ( _
...
[CreateEndsWithRule Overload](9cbb72f8-a097-9b55-bf50-823c7499e8fb.md "CreateEndsWithRule Method")
