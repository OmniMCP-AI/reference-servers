...
---  
```text
Public Shared Function GetSchemasInDocument ( _
...
# ### Parameters
document
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md "Document Class") A document to get numbering schema from. 
# ### Return Value
