...
---  
```text
public static FailureDefinitionId SizingFailed { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property SizingFailed As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ SizingFailed {
