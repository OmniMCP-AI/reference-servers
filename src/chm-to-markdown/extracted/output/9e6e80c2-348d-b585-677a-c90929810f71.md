...
---  
HVACLoadBuildingType Members  
[HVACLoadBuildingType Class](db7c8da2-260f-94b7-990e-f32ad234ec87.md "HVACLoadBuildingType Class") Methods Properties See Also  
---  
The [HVACLoadBuildingType](db7c8da2-260f-94b7-990e-f32ad234ec87.md "HVACLoadBuildingType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](3dfb45e3-59e1-6543-1869-796c94b1965e.md "Create Method") | Creates a building type element. |
...
| [IsValidTime](e367b4dc-a8b1-fc4b-6e7b-bfff3d7dd2c9.md "IsValidTime Method") | Check if the string can be parsed to a valid time for opening time and closing time. A valid string can be "16:30" or "4:30 PM"; |
...
| --- | --- |
| --- | --- | --- |
| [AirChangesPerHour](de814e90-ca51-87fc-7978-2bda93282508.md "AirChangesPerHour Property") | The air changes per hour.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
| [AreaPerPerson](12fe9592-2db9-74b7-151e-0639a61be846.md "AreaPerPerson Property") | The area per person.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [BuildingTypeName](57a7fea5-4711-0cb8-8e9d-24b137387276.md "BuildingTypeName Property") | The building type name. |
...
| [ClosingTime](129e98fa-e1ad-64c1-67e1-1e8e0d1e999f.md "ClosingTime Property") | The closing time of the building type. |
| [CoolingSetPoint](63083e27-82a3-002b-ec31-d64bc3aff3ec.md "CoolingSetPoint Property") | The cooling temperature set point in unit Kelvin (K).  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [DehumidificationSetPoint](129aec52-b9be-7b27-b9c8-6c679f79400c.md "DehumidificationSetPoint Property") | The dehumidification set point as a number between 0 and 1.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [HeatingSetPoint](f50580b5-f523-258c-a468-f8e882c3e75d.md "HeatingSetPoint Property") | The heating temperature set point in unit Kelvin (K).  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
| [HumidificationSetPoint](9eed2c32-b303-dfa8-e851-c4c152049a06.md "HumidificationSetPoint Property") | The humidification set point as a number between 0 and 1.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [LatentHeatGainPerPerson](f69b9dc5-e0c0-41b8-b47a-406def4d4cef.md "LatentHeatGainPerPerson Property") | The latent heat gain per person.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [LightingLoadDensity](cc763ac8-9800-6ab9-f3e5-9401fa081437.md "LightingLoadDensity Property") | The lighting load density.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [OpeningTime](42598222-0828-343b-2caa-957ce41e7984.md "OpeningTime Property") | The opening time of the building type. |
| [OutdoorAirFlowStandard](fadd7366-56f5-a684-e019-34d708dd63b7.md "OutdoorAirFlowStandard Property") | The outdoor airflow standard.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
| [OutdoorAirPerArea](51a96879-efa8-7d0f-2c0f-741de8f9009f.md "OutdoorAirPerArea Property") | The outdoor air per area.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
| [OutdoorAirPerPerson](ac0ab576-b963-40a0-178f-5fccbbd86444.md "OutdoorAirPerPerson Property") | The outdoor air per person.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [PlenumLighting](325c0e6e-6fcb-5d48-179e-09c733e9e6a0.md "PlenumLighting Property") | The percentage of plenum lighting contribution.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
| [PowerLoadDensity](f9c5e47e-a2ec-9581-39d4-7d92c4e60587.md "PowerLoadDensity Property") | The power load density.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
| [SensibleHeatGainPerPerson](ca86f911-10f6-8727-1963-7fbfe7393fee.md "SensibleHeatGainPerPerson Property") | The sensible heat gain per person.  (Inherited from [HVACLoadType](90bf5784-0076-ded0-41fb-38fcb8ed6abe.md "HVACLoadType Class").) |
...
| [UnoccupiedCoolingSetPoint](ca69d367-dcb1-7318-ee7e-012a5bfbb9f2.md "UnoccupiedCoolingSetPoint Property") | The unoccupied cooling set point of the building type with unit kelvin (K). |
