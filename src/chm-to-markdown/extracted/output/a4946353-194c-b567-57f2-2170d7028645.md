...
---  
DisplacementPath Members  
[DisplacementPath Class](90ac4bbb-7f65-763a-bf5e-a76b2a167294.md "DisplacementPath Class") Methods Properties See Also  
---  
The [DisplacementPath](90ac4bbb-7f65-763a-bf5e-a76b2a167294.md "DisplacementPath Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](c3a023a5-b875-4de1-a092-f62002a258cf.md "Create Method") | Creates a new DisplacementPath referencing a DisplacementElement and edge or curve and adds it to the document. |
...
| [IsValidParam](2e1abd7d-718e-26af-7fbc-6746ec2963c2.md "IsValidParam Method") | Is the specified value a valid edge or curve parameter. |
| [IsValidReference](f3c1aeed-e6e3-77cd-1c03-21280f06f755.md "IsValidReference Method") | Does the specified pick represent an edge or a curve belonging to one of the displaced elements. |
...
| [SetAnchorPoint](5d92709f-6736-b8b9-b31b-68f0af5f8ee1.md "SetAnchorPoint Method") | Sets the reference that determines the origin of this DisplacementPath. |
...
| --- | --- |
| --- | --- | --- |
| [AncestorIdx](fed5f5e3-2f84-1ccf-458d-d2c3f30d3a02.md "AncestorIdx Property") | Specifies the end point of the path. |
...
| [PathStyle](b812339e-d1c8-6303-5538-091fdbcaf838.md "PathStyle Property") | Specifies the style of the path. |
