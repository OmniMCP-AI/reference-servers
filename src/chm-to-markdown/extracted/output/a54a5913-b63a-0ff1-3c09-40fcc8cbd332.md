...
Revit 2024 API  
---  
ExporterIFCUtils..::..GetIFCType Method   
...
---  
```text
Public Shared Function GetIFCType ( _
...
# ### Return Value
The IFC type. This is an empty string if the element should not be exported because it is not found in the mapping file. 
# Remarks
