...
Revit 2024 API  
---  
Document..::..Link Method (String, DGNImportOptions, View, ElementId%)  
...
# ### Parameters
file
    Type: System..::..String Full path of the file to link. File must exist and must be a valid DGN file. 
options
