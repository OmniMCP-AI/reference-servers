...
Revit 2024 API  
---  
LoadCombination..::..Create Method (Document, String, LoadCombinationType, LoadCombinationState)  
...
Public Shared Function Create ( _
	...
	name As String, _
	type As LoadCombinationType, _
	state As LoadCombinationState _
) As LoadCombination
```
...
type
    Type: [Autodesk.Revit.DB.Structure..::..LoadCombinationType](cd4f9fcf-2a5c-b887-4b1f-426df941dcf4.md "LoadCombinationType Enumeration") The type of the load combination. 
state
    Type: [Autodesk.Revit.DB.Structure..::..LoadCombinationState](e996d993-abe2-a1f8-a722-aedf6e95cf4a.md "LoadCombinationState Enumeration") The state of the load combination. 
# ### Return Value
