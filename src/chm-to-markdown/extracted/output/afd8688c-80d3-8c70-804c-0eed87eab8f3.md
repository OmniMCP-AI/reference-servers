...
---  
```text
Public Shared Function CreateSheet ( _
	document As Document, _
	assemblyInstanceId As ElementId, _
	titleBlockId As ElementId _
) As ViewSheet
```
...
titleBlockId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") Id of the titleblock family to use. For no titleblock, pass invalidElementId. 
# ### Return Value
...
| --- | --- |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md "ArgumentException Class") | assemblyInstanceId is not an AssemblyInstance. -or- titleBlockId is not a TitleBlock. |
