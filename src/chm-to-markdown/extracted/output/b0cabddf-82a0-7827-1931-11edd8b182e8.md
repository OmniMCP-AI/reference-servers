...
---  
AnalyticalElement Members  
[AnalyticalElement Class](e6a6d29a-9c26-2b3b-996e-213ae906a3af.md "AnalyticalElement Class") Methods Properties See Also  
---  
...
| [GetCurve](1eebc63e-4b20-a2a1-3537-283e2d284ee4.md "GetCurve Method") | Returns the curve of the Analytical Element. |
...
| [GetReference](9804934b-e6dd-3a0f-5994-30307fecca2d.md "GetReference Method") | Returns a reference to a given curve within the Analytical Element. |
...
| [GetTransform](23e0c0f8-3f72-235e-0b1f-b977bbe5d697.md "GetTransform Method") | Returns the transform which reflects Analytical Element orientation. |
...
| [IsSingleCurve](b9d6eb46-2e7d-4501-004e-704b69600d1f.md "IsSingleCurve Method") | Indicates if the Analytical Element can be expressed as a single curve. |
| [IsValidAnalyzeAs](98f5eb53-b973-3cdc-ebce-7f0ee16d1378.md "IsValidAnalyzeAs Method") | Checks whether the value set for Analyze As is valid for an Analytical Element. |
| [IsValidSelector](9b076f25-113f-2c09-d63b-2d2a68082c9b.md "IsValidSelector Method") | Indicates if the input selector is valid for the Analytical Element. |
| [IsValidStructuralRole](c53f8bf2-a819-c1c8-890b-f2571c087549.md "IsValidStructuralRole Method") | Checks whether the value set for Analytical Structural Role is valid for an Analytical Element. |
