...
---  
RebarBarType Members  
[RebarBarType Class](467b44cc-54e7-3ecf-07e1-ad15d05fe800.md "RebarBarType Class") Methods Properties See Also  
---  
The [RebarBarType](467b44cc-54e7-3ecf-07e1-ad15d05fe800.md "RebarBarType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](87e9896d-863b-22e0-482c-92e032d42144.md "Create Method") | Creates a new RebarBarType object |
| [CreateDefaultRebarBarType](be1c7098-bae0-2681-dea7-b081ce1bc698.md "CreateDefaultRebarBarType Method") | Creates a new RebarBarType object with a default name. |
...
| [GetAutoCalcHookLengths](d31c3a4a-7ba2-0ed8-db11-65fa480c6f45.md "GetAutoCalcHookLengths Method") | Identifies if the hook lengths of a hook type are automatically calculated for this bar type |
...
| [GetHookLength](abcf48ad-052f-40bd-ee5f-b5d59d607123.md "GetHookLength Method") | Identifies the hook length for a hook type |
| [GetHookOffsetLength](0a1cd042-dfeb-5a5f-734e-0b91d6a9e8dc.md "GetHookOffsetLength Method") | Identifies the hook offset length for a hook type |
| [GetHookPermission](bea2d183-cf94-dd90-97a0-04096f6c21a3.md "GetHookPermission Method") | Identifies if a hook type is permitted for this bar type |
| [GetHookTangentLength](89dc8618-3109-4905-36b0-a8017044e651.md "GetHookTangentLength Method") | Identifies the hook tangent length for a hook type |
...
| [GetReinforcementRoundingManager](2f5b170f-bb68-127e-adf7-5d0740e137c1.md "GetReinforcementRoundingManager Method") | Returns an object for managing reinforcement rounding override settings. |
...
| [SetAutoCalcHookLengths](21dd89fe-8eac-3209-11f7-9c134f4ec9ef.md "SetAutoCalcHookLengths Method") | Identifies if the hook lengths of a hook type are automatically calculated for this bar type |
| [SetBarTypeDiameters](cb45e0d8-18dc-2376-5952-9226ec8a0ca5.md "SetBarTypeDiameters Method") | Sets all input diameters from diametersOptions in current RebarBarType. |
...
| [SetHookLength](d8a83bf6-d0ad-4bb2-d5b2-c7b026a4d4de.md "SetHookLength Method") | Identifies the hook length for a hook type |
| [SetHookOffsetLength](5e40bac1-64af-fa65-8825-58730e036daa.md "SetHookOffsetLength Method") | Identifies the hook offset length for a hook type |
| [SetHookPermission](7895d053-e52a-3c16-d39f-e1ae26d505e9.md "SetHookPermission Method") | Identifies if a hook type is permitted for this bar type |
| [SetHookTangentLength](4c4ba82f-3645-13bd-1e3e-233f9b9c13b5.md "SetHookTangentLength Method") | Identifies the hook tangent length for a hook type |
...
| [BarModelDiameter](f13299fd-9276-9263-a0cf-20e1b2161afb.md "BarModelDiameter Property") | Defines bar model diameter of rebar |
| [BarNominalDiameter](af82b6df-2053-aa48-ae42-f97349d875af.md "BarNominalDiameter Property") | Defines bar nominal diameter of rebar |
...
| [DeformationType](72c74a9f-1091-5ddb-69d6-93837af6bfee.md "DeformationType Property") | Defines bar deformation type. |
...
| [MaximumBendRadius](06aece02-da41-ef43-97e0-bc2d2f17e366.md "MaximumBendRadius Property") | Defines maximum bend radius of rebar |
...
| [StandardBendDiameter](2ec8bbcf-f2e6-9511-ab34-1cdea8910ef2.md "StandardBendDiameter Property") | Defines bar bend diameter for rebar whose style is standard |
| [StandardHookBendDiameter](87851d76-411f-c305-57a0-aaf75a7d0007.md "StandardHookBendDiameter Property") | Defines hook bend diameter for rebar whose style is standard |
| [StirrupTieBendDiameter](5b62432d-4486-5df5-fc6a-1b2387924d64.md "StirrupTieBendDiameter Property") | Defines bar and hook bend diameter for rebar whose style is stirrup/tie |
