...
---  
```text
Public Shared Function MoveParameterUpOrder ( _
...
parameterId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") The parameter to move up 
# ### Return Value
