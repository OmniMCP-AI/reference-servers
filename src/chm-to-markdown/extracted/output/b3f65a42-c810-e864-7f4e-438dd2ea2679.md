...
---  
RevitLinkInstance Members  
[RevitLinkInstance Class](a3a27c39-75bf-67d1-ae78-4cadd49a9c8e.md "RevitLinkInstance Class") Methods Properties See Also  
---  
The [RevitLinkInstance](a3a27c39-75bf-67d1-ae78-4cadd49a9c8e.md "RevitLinkInstance Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetLinkDocument](6f81c365-15d9-06b8-48ef-df84914fec60.md "GetLinkDocument Method") | The document associated with the Revit link. |
...
| [MoveBasePointToHostBasePoint](052feb8e-e569-ddcd-30b8-a2373d1466f8.md "MoveBasePointToHostBasePoint Method") | Moves this link instance so that the base point in the linked document is aligned to the base point in the host document. This is a one-time movement and does not set up any shared coordinates relationship.  If the rotation angle of this link instance was changed after insertion, the rotation angle can be preserved or reset to the original insertion angle. |
| [MoveOriginToHostOrigin](2ebcfd4d-c7a4-7694-a06b-372c3675cec9.md "MoveOriginToHostOrigin Method") | Moves this link instance so that the internal origin of the linked document is aligned to the internal origin of the host document. This is a one-time movement and does not set up any shared coordinates relationship.  If the rotation angle of the link instance was changed after insertion, the rotation angle can be preserved or reset to the original insertion angle. |
