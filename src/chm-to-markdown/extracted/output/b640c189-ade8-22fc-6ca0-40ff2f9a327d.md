...
---  
ReinforcementSettings Members  
[ReinforcementSettings Class](ca904bb8-c5f4-26bb-6220-9f8d5d1ebd1f.md "ReinforcementSettings Class") Methods Properties See Also  
---  
The [ReinforcementSettings](ca904bb8-c5f4-26bb-6220-9f8d5d1ebd1f.md "ReinforcementSettings Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetFabricRoundingManager](e8fd5c2d-5fa1-1b02-4e4e-4057680a756e.md "GetFabricRoundingManager Method") | Returns an object for managing reinforcement rounding override settings used by FabricSheetType and FabricSheet elements. |
...
| [GetRebarRoundingManager](0471fc13-76ea-a071-b6b6-f26586ba7dd6.md "GetRebarRoundingManager Method") | Returns an object for managing reinforcement rounding override settings used by RebarBarTypes, Rebar and RebarInSystem elements. |
| [GetReinforcementAbbreviationTag](aa2e274b-4a04-2382-958e-ae8c5da76d34.md "GetReinforcementAbbreviationTag Method") | Gets one abbreviation tag for desired ReinforcementAbbreviationTagType. |
| [GetReinforcementAbbreviationTags](c99a81c9-19ec-3983-beb7-e6080a5f6431.md "GetReinforcementAbbreviationTags Method") | Gets a list of abbreviation tags for desired reinforcement object type. |
| [GetReinforcementSettings](870cbfee-b1d4-0dd8-3e14-4802f3eafd25.md "GetReinforcementSettings Method") | Obtains the ReinforcementSettings object for the specified project document. |
...
| [IsEqual](f6924dbf-c3de-6b0a-ba9f-166a9c8a8819.md "IsEqual Method") | Checks if Reinforcement Settings is equal to other |
...
| [SetReinforcementAbbreviationTag](9907ed20-d7dd-f387-01e8-76f66f1c76f2.md "SetReinforcementAbbreviationTag Method") | Sets one abbreviation tag for desired ReinforcementAbbreviationTagType. |
...
| [HostStructuralRebar](e778d21b-369f-ffc2-ab0f-9191fec3cd8f.md "HostStructuralRebar Property") | Host Structural Rebar within Area and Path Reinforcement with touching AtomHostStructuralRebar. |
...
| [NumberVaryingLengthRebarsIndividually](7b74062d-8c65-4145-1d8c-23302ebc5b61.md "NumberVaryingLengthRebarsIndividually Property") | Use this option to modify the way varying length bars are numbered (individually or as a whole). |
...
| [RebarPresentationInSection](511b0bb9-155f-3397-9a13-d41100fc8d72.md "RebarPresentationInSection Property") | The default presentation mode for rebar sets, when: |
...
| [RebarPresentationInView](8a1b166e-3bea-5862-3fa4-996419581c5a.md "RebarPresentationInView Property")|  The default presentation mode for rebar sets, when the view direction is perpendicular to the rebar normal and the rebar set is not cut.   
| [RebarShapeDefinesEndTreatments](1961031f-e056-da42-215f-bf7d3ddcd530.md "RebarShapeDefinesEndTreatments Property")|  End Treatments are defined by Rebar Shape of Rebar element. Can be changed if document contains no rebars, area reinforcements and path reinforcements.   
| [RebarShapeDefinesHooks](dac8f11f-7001-41a2-5b51-5d619a4e2231.md "RebarShapeDefinesHooks Property")|  Hooks are defined by Rebar Shape of Rebar element. Can be changed if document contains no rebars, area reinforcements and path reinforcements.   
| [RebarVaryingLengthNumberSuffix](4fbbb672-5f0c-fc86-3fce-2b1a16127fff.md "RebarVaryingLengthNumberSuffix Property")|  A unique identifier used for a bar within a variable length rebar set.   
