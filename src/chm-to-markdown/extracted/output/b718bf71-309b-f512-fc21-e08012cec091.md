...
Revit 2024 API  
---  
Document..::..NewFascia Method (FasciaType, Reference)  
...
reference
    Type: [Autodesk.Revit.DB..::..Reference](d28155ae-817b-1f31-9c3f-c9c6a28acc0d.md "Reference Class") A planar line or arc that represents the place where you want to place the fascia.
# ### Return Value
