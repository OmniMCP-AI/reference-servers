...
---  
```text
Public Function SetAdditionalElement ( _
	additionalElement As ElementId _
) As FailureMessage
```
...
# ### Parameters
additionalElement
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") The additional element. 
# ### Return Value
The FailureMessage. 
# Remarks
