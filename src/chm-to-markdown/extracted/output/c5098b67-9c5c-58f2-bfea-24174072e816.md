# RemoveIntersectionElement Method
...
---  
```text
Public Sub RemoveIntersectionElement ( _
	referenceElemIdToRemove As ElementId _
)
```
...
# ### Parameters
referenceElemIdToRemove
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") The intersection element to be removed. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
