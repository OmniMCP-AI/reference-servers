# SharedParameterElement Members
...
---  
SharedParameterElement Members  
[SharedParameterElement Class](d8a0f2ae-7e10-39bd-e362-3756cbae661b.md "SharedParameterElement Class") Methods Properties See Also  
---  
The [SharedParameterElement](d8a0f2ae-7e10-39bd-e362-3756cbae661b.md "SharedParameterElement Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](c6430d77-b3e5-2a67-02b2-4896f83ba932.md "Create Method") | Creates a new shared parameter element in the document representing the parameter stored in the input ExternalDefinition. |
...
| [Lookup](4dce82de-7495-523a-c8d4-4b3fc709e85e.md "Lookup Method") | Finds the shared parameter element that corresponds to the given Guid. |
...
| [ShouldHideWhenNoValue](c9cfaeab-a393-e255-fa8e-418afdc6f6c5.md "ShouldHideWhenNoValue Method") | Indicates whether the parameter should be hidden from the properties palette if it has no value. |
...
| [GuidValue](5f6a55c4-a80f-225a-c26b-45e89e91c74c.md "GuidValue Property") | The Guid that identifies this shared parameter. |
