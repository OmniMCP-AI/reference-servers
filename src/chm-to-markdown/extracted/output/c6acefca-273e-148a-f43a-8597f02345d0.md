# SpatialElementFromToCalculationPoints Members
...
---  
SpatialElementFromToCalculationPoints Members  
[SpatialElementFromToCalculationPoints Class](a6fe424e-af41-c1de-7bc2-e6facd9f2386.md "SpatialElementFromToCalculationPoints Class") Methods Properties See Also  
---  
The [SpatialElementFromToCalculationPoints](a6fe424e-af41-c1de-7bc2-e6facd9f2386.md "SpatialElementFromToCalculationPoints Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Flip](7c873a16-4dcd-3a46-6b11-895d4ba48dc8.md "Flip Method") | flip the direction of the "from" and "to" points |
...
| [IsAcceptableFromPosition](4ab4d035-f4cc-1a33-4bd6-77709007c8ff.md "IsAcceptableFromPosition Method") | Checks whether a given "from" position is valid. |
| [IsAcceptableToPosition](b18e836c-0ec0-ad03-1fe5-4df43e2b6ad3.md "IsAcceptableToPosition Method") | Checks whether a given "to" position is valid. |
...
| [MakeFromPositionAcceptable](c873f350-1aab-cba7-19a0-27a66ad68784.md "MakeFromPositionAcceptable Method") | This function takes a potential "from" point and converts it to be a similar point on the opposite side of the family's host from the "to" point if necessary. |
| [MakeToPositionAcceptable](638f8627-4f0a-9873-5012-6f6aef4e2c66.md "MakeToPositionAcceptable Method") | This function takes a potential "to" point and converts it to be a similar point on the opposite side of the family's host from the "from" point if necessary. |
...
| [FromPosition](45dfa54d-baaf-e72f-4216-21c2034fe4f0.md "FromPosition Property") | The "from" position of spatial element connecting calculation point. |
...
| [MarkerPosition](11e13d93-8417-5f44-b33f-3f2ac4169d59.md "MarkerPosition Property") | The position of the spatial element calculation location marker.  (Inherited from [SpatialElementCalculationLocation](f4fed5e0-0964-a973-c8f5-7beb046a2849.md "SpatialElementCalculationLocation Class").) |
...
| [ToPosition](128045fd-8cd1-b9e2-2add-28f92a250876.md "ToPosition Property") | The "to" position of spatial element connecting calculation point. |
