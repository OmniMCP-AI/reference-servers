...
---  
Toposolid Members  
[Toposolid Class](7516b682-d489-a462-47ab-192c63d1d9e4.md "Toposolid Class") Methods Properties See Also  
---  
The [Toposolid](7516b682-d489-a462-47ab-192c63d1d9e4.md "Toposolid Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CreateFromTopographySurface](662a7ccb-63b9-a106-1b3e-659af6a35c70.md "CreateFromTopographySurface Method") | Creates a toposolid element from a host TopographySurface, and toposolid sub-divisions from its subregions. |
| [CreateSubDivision](6120f56d-5fa1-5682-587f-7e790b73f43a.md "CreateSubDivision Method") | Create a toposolid subdivision element with the current toposolid as its host. |
...
| [GetSlabShapeEditor](4b7c441c-9f4f-4756-14bc-5fc387043c3e.md "GetSlabShapeEditor Method") | Gets a SlabShapeEditor that can be used to add or modify points of this Toposolid. |
| [GetSubDivisionIds](0a8cf5c3-61c8-b255-06e7-bb42a9097788.md "GetSubDivisionIds Method") | Get all element ids of toposolid subdivisions with the current toposolid as its host. |
...
| [Simplify](dabded04-9e0a-e675-b90e-8b9b0ae7e479.md "Simplify Method") | Simplifies the toposolid by reducing the number of inner vertices to the given percentage. |
| [Split](a7760dc6-515d-6ac2-6164-d0581c7d6dee.md "Split Method") | Split the toposolid by the given curve loops. |
...
| [HostTopoId](d16ba5b3-da97-b262-3dc8-5de0a9816f74.md "HostTopoId Property") | The host toposolid id of the current toposolid subdivision. If the object is not a toposolid subdivision, hostTopoId will be InvalidElementId. |
...
| [SketchId](e2fc2a37-4ad1-a77f-9454-a7ccd6ea6e9d.md "SketchId Property") | Returns id of the sketch. |
