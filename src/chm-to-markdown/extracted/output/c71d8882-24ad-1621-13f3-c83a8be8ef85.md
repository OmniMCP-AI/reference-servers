# Import Method (String, SATImportOptions, View)
...
Revit 2024 API  
---  
Document..::..Import Method (String, SATImportOptions, View)  
...
# ### Parameters
file
    Type: System..::..String Full path of the file to import. File must exist and must be a valid SAT file. 
options
