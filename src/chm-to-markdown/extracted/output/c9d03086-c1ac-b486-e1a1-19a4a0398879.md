...
---  
RebarHookType Members  
[RebarHookType Class](3c7a78d5-f92b-e58b-e7c9-7927537498fd.md "RebarHookType Class") Methods Properties See Also  
---  
The [RebarHookType](3c7a78d5-f92b-e58b-e7c9-7927537498fd.md "RebarHookType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [Create](e113d22a-0e59-6642-e45d-2538a0d24bff.md "Create Method") | Creates a new RebarHookType in a document. |
| [CreateDefaultRebarHookType](83699313-9138-9a03-2a9a-8f7373fcd535.md "CreateDefaultRebarHookType Method") | Creates a new RebarHookType object with a default name. |
...
| [GetDefaultHookExtension](de092ae2-aed1-186b-a987-cf8e5a84cba6.md "GetDefaultHookExtension Method") | Computes the default hook length, which is equal to barDiameter * multiplier. |
...
| [GetHookExtensionLength](dac6ad67-c23a-c5f0-26ed-4590cbfbc275.md "GetHookExtensionLength Method") | Computes the hook extension length based on current hook length |
...
| [IsOffsetLengthRequired](4a11667a-73c9-a7a7-83a7-799cc45df5c2.md "IsOffsetLengthRequired Method") | Check whether hook offset length is required. remarks: If hook angle is no more than 90 degree, hook offset length is not meaningful. returns: True if hook offset length is required, otherwise false. |
...
| [HookAngle](85af7224-b751-4c40-a5d5-5b4dc757f742.md "HookAngle Property") | The hook angle, measured in radians. Must be greater than 0 and no more than pi. |
...
| [StraightLineMultiplier](28ab6bf6-6aef-39d7-c9b7-98e16cdc02d2.md "StraightLineMultiplier Property") | Multiplier of bar diameter. Used to compute a default hook length. The default hook length can be overridden by the RebarBarType class. |
| [Style](3a223d55-0f7e-aa63-7314-e8ad1cd525c9.md "Style Property") | The hook may only be applied to shapes of the specified style. |
