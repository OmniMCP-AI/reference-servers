# InvalidLoadClassificationValue Property
...
---  
```text
public static FailureDefinitionId InvalidLoadClassificationValue { get; }
```
  
Visual Basic  
---  
```text
Public Shared ReadOnly Property InvalidLoadClassificationValue As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ InvalidLoadClassificationValue {
