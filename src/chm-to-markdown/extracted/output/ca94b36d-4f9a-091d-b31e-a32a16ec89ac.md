...
---  
Part Members  
[Part Class](1ee04db6-195f-58fa-a245-5a2f2d404200.md "Part Class") Methods Properties See Also  
---  
The [Part](1ee04db6-195f-58fa-a245-5a2f2d404200.md "Part Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanOffsetFace](ca466002-8d4e-bd3c-e591-5ca37c983bb1.md "CanOffsetFace Method") | Checks if it is possible to offset the given face. |
...
| [GetFaceOffset](a4bb499a-8705-5138-0e15-74fb5bc4508b.md "GetFaceOffset Method") | Get face offset of the given part face. |
...
| [GetSourceElementIds](35943e3b-b8d2-2bd6-6258-27599d012ee8.md "GetSourceElementIds Method") | Gets a collection of elements from which this Part is created by the PartMaker. May return more than one source only if there is merge involved somewhere in the history of this Part. |
| [GetSourceElementOriginalCategoryIds](47f225e0-6be6-22fc-8005-4f0e68d95674.md "GetSourceElementOriginalCategoryIds Method") | Gets the category ids of the source elements which were used to form this part. |
...
| [ResetFaceOffset](6e715369-6f25-adec-e331-25f43d9a75fd.md "ResetFaceOffset Method") | Resets the offset applied to the given part face. |
| [ResetPartShape](9cedb531-7e03-ae4d-53d8-4561dbbb7f23.md "ResetPartShape Method") | Resets all face offsets applied to part faces. |
...
| [SetFaceOffset](6d2cb1e0-1754-8f71-f02f-70c153fe6bde.md "SetFaceOffset Method") | Offsets the given part face in the direction that points out of the solid shape with the specified amount. Negative value will offset the face into the solid shape. |
...
| [Excluded](0eb9588f-17af-18d7-f9ed-cc831b0585db.md "Excluded Property") | True if the part is excluded, false otherwise |
...
| [OriginalCategoryId](a06ea771-6aea-6a39-9036-4d3f1389b7ed.md "OriginalCategoryId Property") | The category Id of the original element corresponding to this Part. |
...
| [PartMaker](67743418-5f84-a6b6-cfcf-14d8072391b1.md "PartMaker Property") | The PartMaker that created this Part. |
