...
Revit 2024 API  
---  
PropertySetElement..::..Create Method (Document, ThermalAsset)  
...
thermalAsset
    Type: [Autodesk.Revit.DB..::..ThermalAsset](c4dac7e3-96e2-bc6c-1299-f696a253e879.md "ThermalAsset Class") The thermal asset containing the values that will be present in the PropertySetElement. 
# ### Return Value
