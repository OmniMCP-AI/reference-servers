...
---  
StartingViewSettings Members  
[StartingViewSettings Class](aaa6f49c-faeb-851e-45e9-d3d5799c1753.md "StartingViewSettings Class") Methods Properties See Also  
---  
The [StartingViewSettings](aaa6f49c-faeb-851e-45e9-d3d5799c1753.md "StartingViewSettings Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetStartingViewSettings](84788ba0-4edd-5483-eb22-898dbc21520b.md "GetStartingViewSettings Method") | Returns the starting view settings for the specified document. |
...
| [IsAcceptableStartingView](7118b9ba-d29e-78d2-9293-705de4726980.md "IsAcceptableStartingView Method") | Checks whether the given Id is an acceptable starting view. InvalidElementId corresponds to "Last Viewed" and is therefore also acceptable. |
...
| [ViewId](dd5cd741-e211-9bb3-666c-ee056520c2d9.md "ViewId Property") | Indicates the specific view that will be opened when the model is loaded. InvalidElementId indicates that no view has been specified. In that case, Revit will open the last views that were open at the time the file was saved. |
