# NewFamilyInstanceCreationData Method (XYZ, FamilySymbol, Element, Level, StructuralType)
...
Revit 2024 API  
---  
Application..::..NewFamilyInstanceCreationData Method (XYZ, FamilySymbol, Element, Level, StructuralType)  
