...
---  
MEPSystem Members  
[MEPSystem Class](65946955-8638-fafb-2657-ef7cb7b2941b.md "MEPSystem Class") Methods Properties See Also  
---  
The [MEPSystem](65946955-8638-fafb-2657-ef7cb7b2941b.md "MEPSystem Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [Add](f40dba23-b703-6a37-0e09-7dfcd2eb1955.md "Add Method") | Add elements into the system and connect them with the system using given connectors. |
...
| [DivideSystem](1bb1e7d5-a9f6-0c2d-e413-064bd4aa2c02.md "DivideSystem Method") | Divide the phyisical networks in the system and create a new system for each network. |
...
| [GetCriticalPathSectionNumbers](b68ff5b9-e8cf-2565-2b50-03a8d2489ac3.md "GetCriticalPathSectionNumbers Method") | Obtains a list of the critical path section numbers. |
...
| [GetPhysicalNetworksNumber](23ca7db4-fa65-1149-95d7-9f17b80e073a.md "GetPhysicalNetworksNumber Method") | Get the physical networks number in the system. |
| [GetSectionByIndex](dd53cbe2-37e6-19a1-e627-74a2aacb3433.md "GetSectionByIndex Method") | Get the section from the index. |
| [GetSectionByNumber](11cc783a-32f8-b0e0-2da6-5ecc6b9e57a6.md "GetSectionByNumber Method") | Get the Section from section number |
...
| [IsSystemDividable](4764bc4f-7ca7-820e-2b06-ac1a25750971.md "IsSystemDividable Method") | Checks if the system is dividable. The system is dividable if there is more than one physical network in the system. Currently, only HVAC and piping systems support dividing. |
...
| [Remove(ConnectorSet)](59f27f95-ca35-d3e1-ccf4-5103133be3b1.md "Remove Method \(ConnectorSet\)") | Removes connectors from system. |
| [Remove(ICollection<(Of <<'(ElementId>)>>))](712cb969-3aaf-d7f8-eece-ad121093784e.md "Remove Method \(ICollection\(ElementId\)\)") | Remove elements from system. |
...
| [BaseEquipment](00d90c4f-1946-1069-7887-f12899846481.md "BaseEquipment Property") | The base panel or equipment of the system. |
| [BaseEquipmentConnector](ba498d21-cdd8-ef07-e906-410443befc47.md "BaseEquipmentConnector Property") | The connector within base equipment which is used to connect with system. |
...
| [ConnectorManager](891c572c-e7de-8593-330d-5afc8aed9e63.md "ConnectorManager Property") | Connector manager of the system. |
...
| [Elements](c1cb0808-3b81-87a5-b804-84a733686f2d.md "Elements Property") | Terminal elements in the system. |
...
| [HasDesignParts](2eeb83d4-64d1-a6b7-9116-9b687037406a.md "HasDesignParts Property") | Indicates if the system has one or more design parts. |
| [HasFabricationParts](1d649db3-79da-5cf7-5224-1dd689240afa.md "HasFabricationParts Property") | Indicates if the system has one or more fabrication parts. |
| [HasPlaceholders](e89c9b10-e8d5-5cda-5190-94ac03b704fe.md "HasPlaceholders Property") | Indicates if the system has one or more placeholders. |
...
| [IsEmpty](3c5bb767-5e7a-0080-45e9-c16b161a0e10.md "IsEmpty Property") | Indicates if the system is empty or not. |
...
| [IsMultipleNetwork](dce222a6-f12a-5db6-8ebb-84ac1ecf57f0.md "IsMultipleNetwork Property") | Indicates if the system is well connected or not. The flag will enable the "Divide System" button. |
...
| [IsValid](700f2642-f813-1955-d3c3-8bb99ac1b125.md "IsValid Property") | Indicates if the system is valid or not. atom AtomValidateSystem default false |
...
| [PressureLossOfCriticalPath](d44592e9-ab39-2d59-5872-0c58885839dd.md "PressureLossOfCriticalPath Property") | The total pressure loss of the sections in critical path. |
| [SectionsCount](530f3786-cac3-01c6-8ba8-7bccab7d3d49.md "SectionsCount Property") | The number of sections. |
