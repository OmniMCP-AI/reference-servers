...
Public Sub SetUsageIds ( _
	usageIds As IList(Of ElementId) _
)
```
...
# ### Parameters
usageIds
    Type: System.Collections.Generic..::..IList<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class")>)>)> A collection of the load combination usage IDs. 
# Examples
CopyC#
```text
