...
---  
ImageType Members  
[ImageType Class](c6213f81-8dc8-158e-0522-70f87e9bdbb9.md "ImageType Class") Methods Properties See Also  
---  
The [ImageType](c6213f81-8dc8-158e-0522-70f87e9bdbb9.md "ImageType Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanReload](6090600f-8d4c-511d-a7c5-a21caf768bfc.md "CanReload Method") | Check whether the ImageType can be reloaded from file. |
...
| [Create](31bb13e3-e8f5-cb66-18d0-619578d56cde.md "Create Method") | Creates a new ImageType element and loads the image into it. |
...
| [GetImage](39ae2f0d-11f1-96be-e12b-bfbc4a6c7fae.md "GetImage Method") | Get the bitmap image stored in the image symbol. |
...
| [Reload](9d45a435-bf47-e6a7-15b2-7f5584d260ec.md "Reload Method") | Reloads the ImageType from the file found at the location specified by the [Path](11e87696-9900-94f4-48f9-2e307dd9aae1.md "Path Property") property, using the same [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.md "PageNumber Property") and resolution. |
| [ReloadFrom](e009ad38-c172-fdf4-56b8-c3be5940cc05.md "ReloadFrom Method") | Reloads the image in the ImageType from a new image file, and for a new [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.md "PageNumber Property"). |
...
| [Unload](386b1797-4550-8e3d-d67e-0ac45e2091b0.md "Unload Method") | Unload the linked image. |
...
| [ExternalResourceType](87b4d0ea-c7bb-8063-b4d4-c81b9213ca55.md "ExternalResourceType Property") | The type of external resources that represents images. |
...
| [Height](d28540c9-4ae4-420f-ad9b-ce1d92cf1114.md "Height Property") | The vertical size of the image |
| [HeightInPixels](ec9625b0-d4d4-0430-4407-3d3f56f4ce0f.md "HeightInPixels Property") | Number of pixels in the vertical direction of the image |
...
| [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.md "PageNumber Property") | The number of the page in a multi-page file, that was used to create the image in the ImageType. |
...
| [Path](11e87696-9900-94f4-48f9-2e307dd9aae1.md "Path Property") | The path to the file from which the ImageType was loaded. |
| [PathType](c50808f3-77e5-9606-ec79-721c03873ed2.md "PathType Property") | The path type that was used to refer to the file from which the ImageType was loaded. |
...
| [Resolution](f87ffd66-9385-3380-d1fd-41fe0f045067.md "Resolution Property") | The size of the pixels in the image, expressed in dots-per-inch (dpi) |
| [Source](ebd4da4a-d8da-fe29-8eb4-0c20b678ae02.md "Source Property") | The source of the image in the ImageType. |
| [Status](5f3ddbfe-0d79-a6d4-4170-d9615a764622.md "Status Property") | The status of the image |
...
| [Width](80cccf6d-e10b-8c8b-f536-b3d2e9443a75.md "Width Property") | The horizontal size of the image |
| [WidthInPixels](2e5bdc03-43f0-e718-7c7b-75781cdfdb19.md "WidthInPixels Property") | Number of pixels in the horizontal direction of the image |
