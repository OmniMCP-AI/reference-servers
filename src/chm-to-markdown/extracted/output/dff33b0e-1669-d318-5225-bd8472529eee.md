...
# ### Parameters
layer
    Type: [Autodesk.Revit.DB.Structure..::..AreaReinforcementLayerType](46b15eb7-46c4-2ed9-df2d-417777518f18.md "AreaReinforcementLayerType Enumeration") The layer type for which will return the number of lines. 
# ### Return Value
