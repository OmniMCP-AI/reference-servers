...
| --- | --- |
| --- | --- | --- |
| [AccessDeniedException](f280ddf5-9f59-eca8-634e-ace30de1f4bb.md "AccessDeniedException Class") |
...
| [DefaultValueException](b26719be-e9a8-eab2-3fac-66bc8765febe.md "DefaultValueException Class") | The exception thrown when Revit cannot initialize a default value for a family parameter. |
| [DirectoryNotEmptyException](9614b41a-e3ea-eed0-d74d-57337e6f4888.md "DirectoryNotEmptyException Class") | The exception that is thrown when a method received a directory as an argument and requires that the directory be empty but the directory is not empty. |
