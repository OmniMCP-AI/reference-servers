...
error
    Type: [Autodesk.Revit.DB.Structure..::..RebarFreeFormValidationResult](def069dd-2e03-7b93-6482-9bf28c70e7ed.md "RebarFreeFormValidationResult Enumeration")% Will be Success if everything is ok, otherwise the failure reason. 
# ### Return Value
