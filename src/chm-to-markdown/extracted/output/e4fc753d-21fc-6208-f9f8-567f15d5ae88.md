...
---  
SelectionFilterElement Members  
[SelectionFilterElement Class](b0aaf230-e034-8466-c1e4-1d91e7162d19.md "SelectionFilterElement Class") Methods Properties See Also  
---  
The [SelectionFilterElement](b0aaf230-e034-8466-c1e4-1d91e7162d19.md "SelectionFilterElement Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddSet](c486928c-cb19-29ab-3046-552e81674ccd.md "AddSet Method") | Adds a set of ElementIds to the filter's set. |
| [AddSingle](c8853934-1e21-98a7-0aa3-44bd2dd6bfd6.md "AddSingle Method") | Adds a single ElementId to the filter's set. |
...
| [Clear](7f483abc-ae0f-3c0c-a3fc-b78ae1fcf54b.md "Clear Method") | Removes all ElementIds from the filter. |
| [Contains](cae581e6-0aa0-10bd-827a-14392cacaf79.md "Contains Method") | Returns true if the given ElementId is a member of this filter's set. |
| [Create](5c70f0d8-1a1c-e850-eb69-52d36070eba9.md "Create Method") | Creates a new SelectionFilterElement in the given document. |
...
| [GetElementIds](42b70399-d151-8a68-8df6-546492c7091d.md "GetElementIds Method") | Returns the set of ElementIds contained by this filter. |
...
| [IsEmpty](343559df-977d-aa0f-d1c8-fdd75f439744.md "IsEmpty Method") | Determines whether this filter's set is empty or not. |
...
| [RemoveSet](c08b7b0f-8a65-e0d0-107e-ee9a9cc54806.md "RemoveSet Method") | Removes a set of ElementIds from the filter's set. |
| [RemoveSingle](6fdfc521-9c3c-5a9a-a549-85df55967a51.md "RemoveSingle Method") | Removes a single ElementId from the filter's set. |
| [SetElementIds](1c3d03d1-e917-4513-f260-d8a33fa818ca.md "SetElementIds Method") | Replaces the set of ElementIds contained by this filter. |
