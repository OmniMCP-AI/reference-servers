# Get(FieldType) Method (String, ForgeTypeId)
...
Revit 2024 API  
---  
Entity..::..Get<(Of <(<'FieldType>)>)> Method (String, ForgeTypeId)  
...
# ### Parameters
fieldName
    Type: System..::..String The name of the field to retrieve. 
unitTypeId
    Type: [Autodesk.Revit.DB..::..ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md "ForgeTypeId Class") Identifier of the unit to which the value will be converted before returning. Must be compatible with the spec specified when creating the Schema. 
# Type Parameters
FieldType
