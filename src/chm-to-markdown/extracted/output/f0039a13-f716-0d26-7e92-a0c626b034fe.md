# Create Method (View, XYZ, XYZ, PathOfTravelCalculationStatus)
...
Revit 2024 API  
---  
PathOfTravel..::..Create Method (View, XYZ, XYZ, PathOfTravelCalculationStatus%)  
...
Public Shared Function Create ( _
	...
	pathStart As XYZ, _
	pathEnd As XYZ, _
	<OutAttribute> ByRef resultStatus As PathOfTravelCalculationStatus _
) As PathOfTravel
```
...
resultStatus
    Type: [Autodesk.Revit.DB.Analysis..::..PathOfTravelCalculationStatus](c87dc425-1e13-40b9-df6d-08fde112210b.md "PathOfTravelCalculationStatus Enumeration")% Result status of path of travel creation. 
# ### Return Value
