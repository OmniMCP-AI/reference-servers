# SetCutBackgroundPatternId Method
...
---  
```text
Public Function SetCutBackgroundPatternId ( _
...
# ### Parameters
fillPatternId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") Value of the cut face background fill pattern override. 
# ### Return Value
