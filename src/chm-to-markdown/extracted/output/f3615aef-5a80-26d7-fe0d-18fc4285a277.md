...
---  
Family Members  
[Family Class](f51d019d-6ff3-692b-d1d2-b497cab564de.md "Family Class") Methods Properties See Also  
---  
...
| [CanHaveStructuralSection](75ba21e6-72ec-de95-5e45-8d20630260e3.md "CanHaveStructuralSection Method") | Identifies if this Family can have a structural section. |
...
| [CanLoadFamilies](f9fbccbe-7727-69b5-6253-dcedbbedafde.md "CanLoadFamilies Method") | Checks whether the document is in a state that allows the loading of families. |
...
| [ExtractPartAtom](d477cf8f-0dfe-4055-a787-315c84ef5530.md "ExtractPartAtom Method") | Writes a PartAtom XML from the contents of a family object. |
...
| [GetFamilySymbolIds](8989a269-c516-0ace-5365-864a61df1103.md "GetFamilySymbolIds Method") | Gets the ids of the FamilySymbols owned by this Family. |
| [GetFamilyTypeParameterValues](a9c8ff23-17ec-1b87-e58a-4be589217766.md "GetFamilyTypeParameterValues Method") | Returns all applicable values for a FamilyType parameter of this family. |
...
| [HasLargeSketches](c49820d6-d8f2-de9a-544d-f896a32e39c8.md "HasLargeSketches Method") | Checks whether the family contains sketches with a large number of elements. |
...
| [IsAppropriateCategoryId](430baffa-8a85-0745-5c37-72ae41386b74.md "IsAppropriateCategoryId Method") | Identifies if the input category id can be assigned as the new category for this family. |
