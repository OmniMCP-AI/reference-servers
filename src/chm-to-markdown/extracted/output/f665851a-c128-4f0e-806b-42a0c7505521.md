...
---  
```text
Public Function GetHCurveNormalAtStation ( _
	station As Double _
) As XYZ
```
...
# ### Parameters
station
    Type: System..::..DoubleAlignment station to calculate 2d horizontal normal for, in Revit internal model units (standard Imperial feet).
# ### Return Value
