...
---  
GlobalParameter Members  
[GlobalParameter Class](b0e53a4a-84ad-abb4-358d-9797870f101b.md "GlobalParameter Class") Methods Properties See Also  
---  
The [GlobalParameter](b0e53a4a-84ad-abb4-358d-9797870f101b.md "GlobalParameter Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [CanChangeReporting](4cb16ada-5e43-4307-3886-61a868c8a0dc.md "CanChangeReporting Method") | Tests whether the global parameter permits a change of its current value of the IsReporting attribute. |
...
| [CanLabelDimension](be059016-a7dc-6995-0f11-f56f59555183.md "CanLabelDimension Method") | Tests whether a dimension can be labeled by the global parameter. |
...
| [Create](d3a16d9e-50d0-b1e6-3beb-126356afb73f.md "Create Method") | Creates a new Global Parameter in the given document. |
...
| [GetAffectedElements](c1eb340d-471d-4810-92fe-a2bd6374fc1f.md "GetAffectedElements Method") | Returns all elements of which properties are driven by this global parameter. |
| [GetAffectedGlobalParameters](2028f8a1-2691-e921-8a56-882b1e4080f3.md "GetAffectedGlobalParameters Method") | Returns all other global parameters which refer to this global parameter in their formulas. |
| [GetDefinition](ec9b3cd3-4379-6eb8-7c7d-c220ba03f359.md "GetDefinition Method") | Get the definition representing this parameter element.  (Inherited from [ParameterElement](2ad60b36-07d6-6aed-62c7-89f388f05ffb.md "ParameterElement Class").) |
...
| [GetFormula](4fb83945-2484-3709-6036-adfa4f411f28.md "GetFormula Method") | Returns the parameter's expression in form of a string. |
...
| [GetLabeledDimensions](97d29291-74c4-2da5-2ac5-2fa0c0ac9d0c.md "GetLabeledDimensions Method") | Returns all dimension elements that are currently labeled by this global parameter. |
| [GetLabelName](020d91e9-ebea-2449-a747-72a8613f4765.md "GetLabelName Method") | Returns the name of this parameter's label, which is used to label dimension elements. |
...
| [GetValue](56eb0e54-eac4-9b51-3122-e4fb065b63f0.md "GetValue Method") | Obtains the curent value of the global parameter. |
...
| [HasValidTypeForReporting](8ec3a25e-018b-8903-01d1-6201531c50a0.md "HasValidTypeForReporting Method") | Tests that the global parameter has data of a type that supports reporting. |
...
| [IsValidFormula](50c83d89-22da-4398-bba8-197345f76192.md "IsValidFormula Method") | Tests that the given expression is a valid as formula for this parameter. |
...
| [LabelDimension](99bc1f7d-82b8-7dc1-9919-e73834bb565c.md "LabelDimension Method") | Labels a dimension with this global parameter. |
...
| [SetDrivingDimension](017b2d21-0ed9-fc04-dd7c-19d78214859d.md "SetDrivingDimension Method") | Set a dimension to drive the value of this parameter. |
...
| [SetFormula](7974796f-5771-6640-ce74-0be23eab58d0.md "SetFormula Method") | Sets a formula expression for this parameter. |
| [SetValue](df012c22-6e65-8de5-1057-f15660d02288.md "SetValue Method") | Sets a new value of the global parameter. |
| ToString | Returns a string that represents the current object. (Inherited from Object.) |
| [UnlabelDimension](b862ea70-8b3a-2800-f434-7163a878deeb.md "UnlabelDimension Method") | Unlabels a dimension that is currently labeled by this global parameter. |
...
| [IsDrivenByDimension](201f3932-eece-37b0-be27-3e74ce0c3fb9.md "IsDrivenByDimension Property") | Indicates whether this parameter is driven by a dimension or not. |
| [IsDrivenByFormula](ee9c7baa-47b9-f84d-c2e2-103711fbb756.md "IsDrivenByFormula Property") | Indicates whether this parameter is driven by a formula or not. |
...
| [IsReporting](41d62d48-8d78-d056-b0ca-9ea4777dc827.md "IsReporting Property") | Indicates whether this is a reporting global parameter or not. |
