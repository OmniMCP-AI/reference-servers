...
Revit 2024 API  
---  
ParameterTypeId..::..RebarFreeFormHookStartPlaneAngle Property   
...
---  
```text
Public Shared ReadOnly Property RebarFreeFormHookStartPlaneAngle As ForgeTypeId
	Get
```
...
```text
public:
static property ForgeTypeId^ RebarFreeFormHookStartPlaneAngle {
	ForgeTypeId^ get ();
}
```
