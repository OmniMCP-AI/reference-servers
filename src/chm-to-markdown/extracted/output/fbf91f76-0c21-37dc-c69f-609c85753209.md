...
Revit 2024 API  
---  
DetailElementOrderUtils..::..BringForward Method (Document, View, ICollection<(Of <(<'ElementId>)>)>)  
...
detailElementIds
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class")>)>)> The details to bring forward. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
