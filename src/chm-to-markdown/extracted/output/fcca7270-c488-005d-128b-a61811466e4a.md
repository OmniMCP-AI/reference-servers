...
---  
AssemblyInstance Members  
[AssemblyInstance Class](4e60704c-dfe3-72b6-7892-6440503fa078.md "AssemblyInstance Class") Methods Properties See Also  
---  
The [AssemblyInstance](4e60704c-dfe3-72b6-7892-6440503fa078.md "AssemblyInstance Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
| [AddMemberIds](cd0c727f-218c-a506-b0b5-4550ca6741bf.md "AddMemberIds Method") | Adds member element ids for the assembly instance. |
| [AllowsAssemblyViewCreation](63d643a0-7da2-eecb-d895-4e4603ede331.md "AllowsAssemblyViewCreation Method") | Returns true if assembly views can be created for this Assembly Instance. |
| [AreElementsValidForAssembly](b86d920d-dd9e-db71-c650-cdfbf623942d.md "AreElementsValidForAssembly Method") | Identifies if provided assembly members are valid. |
...
| [CanRemoveElementsFromAssembly](6eadcc05-6ac5-81f4-79ee-4893a050d34b.md "CanRemoveElementsFromAssembly Method") | Identifies if provided assembly members can be removed from the assembly instance. |
...
| [CompareAssemblyInstances](d7253e56-f112-45d0-8b59-f6cb86b42159.md "CompareAssemblyInstances Method") | Compares two assembly instances and returns a result with details about the differences |
| [Create](e0a37a7b-b157-b992-21d2-95f68cc76abd.md "Create Method") | Creates a new assembly instance. |
...
| [Disassemble](a2c65159-bd72-1a16-f95e-c2a5fac474b0.md "Disassemble Method") | Removes the assembly instance and releases the member elements. |
...
| [GetCenter](fa4de5ef-39ef-b51e-8625-b33970326324.md "GetCenter Method") | Returns the center of the bounding box for the assembly instance. This is the default position for placed assembly instances. |
...
| [GetMemberIds](09acaa13-d13a-776b-6019-fd5840dad996.md "GetMemberIds Method") | Gets member element ids for the assembly instance. |
...
| [GetTransform](e369679d-a16e-ef8a-76fe-e69922540c73.md "GetTransform Method") | Gets the origin of the assembly instance. |
...
| [IsMember](d66ca433-7280-d951-74ba-7868e7f54376.md "IsMember Method") | Determines whether the given ElementId is a member of this assembly |
...
| [IsValidNamingCategory](787779c8-a2ed-d7c4-5cf2-0cc5c20de50e.md "IsValidNamingCategory Method") | Identifies if the naming category is valid for an assembly instance. |
...
| [PlaceInstance](3b78e1fa-58d2-2e47-9955-78646763fdd0.md "PlaceInstance Method") | Places an assembly instance of a given assembly type at the specified location. |
...
| [RemoveMemberIds](b7c2e124-12cb-ec24-69b1-afc75ddd199e.md "RemoveMemberIds Method") | Removes member element ids from the assembly instance. |
...
| [SetMemberIds](ae1f25f5-d8c8-ee29-9725-2d3b578da780.md "SetMemberIds Method") | Sets member element ids for the assembly instance. All existing members are cleared. |
| [SetTransform](6e131a7a-8a41-04ba-cb9a-a1b50a0ddd18.md "SetTransform Method") | Sets the origin of the assembly instance. |
...
| [AssemblyTypeName](182e1b2e-a25d-4597-ef28-68df80023a5d.md "AssemblyTypeName Property") | The name for the assembly type. All matching assembly instances share this name. Unique assembly instances are named automatically based on their naming category. |
...
| [Location](f1ffc6ac-24ce-4d10-9c9a-24a99ffaf94d.md "Location Property") | This property is used to find the physical location of the assembly instance within project. (Overrides [Element..::..Location](89438f4f-7e15-835a-0c66-d6adbc8dd00c.md "Location Property").) |
...
| [NamingCategoryId](5a4c70fa-83cc-d594-2dda-84f3386ceae7.md "NamingCategoryId Property") | Id of the category that drives the default naming scheme for the assembly instance. |
