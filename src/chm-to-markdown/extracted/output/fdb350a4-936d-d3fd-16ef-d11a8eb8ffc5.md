...
Public Sub New ( _
	...
	boltSpacingTwoRows As Double, _
	boltSpacingBetweenRows As Double, _
...
boltSpacingTwoRows
    Type: System..::..Double Standard bolt spacing for two rows , in. (mm) 
boltSpacingBetweenRows
    Type: System..::..Double Standard bolt spacing between rows, in. (mm) 
boltDiameter
