# AddMassLevelDataToMassInstance Method
...
---  
```text
Public Shared Function AddMassLevelDataToMassInstance ( _
...
levelId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md "ElementId Class") The ElementId of the Level to associate with the mass instance. 
# ### Return Value
