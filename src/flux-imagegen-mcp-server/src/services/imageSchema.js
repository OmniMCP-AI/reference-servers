...
export const downloadImageSchema = {
  name: 'downloadImage',
  description: 'Download an image from a URL and save it to the images folder',
  parameters: {
    type: 'object',
    required: ['imageUrl'],
    properties: {
      ...
      fileName: {
        type: 'string',
        description: 'Optional: Custom filename for the downloaded image (without extension)'
      },
      format: {
        type: 'string',
