"""
MCP Send to Feishu Server Package
...
logger.info(f"Loaded mcp-server-send-to-feishu version {__version__}")
...
def main():
    ...
    Examples:
        ...
        python -m mcp_server_send_to_feishu --debug --log-file=logfile.log
    """
    parser = argparse.ArgumentParser(description='MCP Send to Feishu Server')
